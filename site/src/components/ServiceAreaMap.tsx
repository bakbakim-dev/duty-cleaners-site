...
/**
 * Lazy shell for ServiceAreaMap. The map itself, and Leaflet with it (42 KB gzipped),
 ...
 */
const Impl = lazy(() => import("./ServiceAreaMapImpl"));
...
type Params = Parameters<(typeof import("./ServiceAreaMapImpl"))["default"]>;
