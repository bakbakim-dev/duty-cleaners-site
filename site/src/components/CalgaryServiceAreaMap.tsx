...
/**
 * Lazy shell for CalgaryServiceAreaMap. The map itself, and Leaflet with it (42 KB gzipped),
 ...
 */
const Impl = lazy(() => import("./CalgaryServiceAreaMapImpl"));
...
type Params = Parameters<(typeof import("./CalgaryServiceAreaMapImpl"))["default"]>;
type Props = Params extends [infer P] ? (P extends object ? P : Record<never, never>) : Record<never, never>;

export default function CalgaryServiceAreaMap(props: Props) {
  return (
