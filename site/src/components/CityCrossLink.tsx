...
export default function CityCrossLink({ city, to, description }: CityCrossLinkProps) {
  return (
    <div className="mx-auto mt-12 max-w-4xl">
      <Link
        to={to}
        className="group flex flex-col items-start gap-5 rounded-2xl bg-brand-navy p-6 text-brand-navy-foreground shadow-lg shadow-brand-navy/15 transition-all duration-300 ease-out hover:-translate-y-1.5 hover:shadow-xl hover:shadow-brand-navy/25 sm:flex-row sm:items-center sm:justify-between sm:p-8"
      >
        ...
        <span className="inline-flex shrink-0 items-center gap-2 font-semibold text-brand-gold">
