...
/**
 * Lazy shell for EdmontonServiceAreaMap. The map itself, and Leaflet with it (42 KB gzipped),
 ...
 */
const Impl = lazy(() => import("./EdmontonServiceAreaMapImpl"));
...
type Params = Parameters<(typeof import("./EdmontonServiceAreaMapImpl"))["default"]>;
type Props = Params extends [infer P] ? (P extends object ? P : Record<never, never>) : Record<never, never>;

export default function EdmontonServiceAreaMap(props: Props) {
  return (
