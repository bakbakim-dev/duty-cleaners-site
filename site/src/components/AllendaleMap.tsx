...
/**
 * Lazy shell for AllendaleMap. The map itself, and Leaflet with it (42 KB gzipped),
 ...
 */
const Impl = lazy(() => import("./AllendaleMapImpl"));
...
type Params = Parameters<(typeof import("./AllendaleMapImpl"))["default"]>;
type Props = Params extends [infer P] ? (P extends object ? P : Record<never, never>) : Record<never, never>;

export default function AllendaleMap(props: Props) {
  return (
