...
export default function SummersideMapImpl() {
  ...
  useEffect(() => {
    ...
    const markers = [
      { pos: [53.4375, -113.546] as [number, number], label: "Summerside, Edmonton" },
      { pos: [53.4365, -113.540] as [number, number], label: "Summerside Beach & Lake" },
      { pos: [53.4400, -113.550] as [number, number], label: "Summerside Community Centre" },
    ];
