...
export default function InglewoodMapImpl() {
  ...
  useEffect(() => {
    ...
    L.marker([53.558, -113.542], {
      ...
      alt: "Inglewood, Edmonton",
      title: "Inglewood, Edmonton",
    })
      .addTo(map)
      .bindPopup("<strong>Inglewood, Edmonton</strong>")
      .openPopup();
