...
/**
 * Lazy shell for SummersideMap. The map itself, and Leaflet with it (42 KB gzipped),
 ...
 */
const Impl = lazy(() => import("./SummersideMapImpl"));
...
type Params = Parameters<(typeof import("./SummersideMapImpl"))["default"]>;
type Props = Params extends [infer P] ? (P extends object ? P : Record<never, never>) : Record<never, never>;

export default function SummersideMap(props: Props) {
  return (
