...
/**
 * Lazy shell for InglewoodMap. The map itself, and Leaflet with it (42 KB gzipped),
 ...
 */
const Impl = lazy(() => import("./InglewoodMapImpl"));
...
type Params = Parameters<(typeof import("./InglewoodMapImpl"))["default"]>;
type Props = Params extends [infer P] ? (P extends object ? P : Record<never, never>) : Record<never, never>;

export default function InglewoodMap(props: Props) {
  return (
