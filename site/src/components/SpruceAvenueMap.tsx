...
/**
 * Lazy shell for SpruceAvenueMap. The map itself, and Leaflet with it (42 KB gzipped),
 ...
 */
const Impl = lazy(() => import("./SpruceAvenueMapImpl"));
...
type Params = Parameters<(typeof import("./SpruceAvenueMapImpl"))["default"]>;
type Props = Params extends [infer P] ? (P extends object ? P : Record<never, never>) : Record<never, never>;

export default function SpruceAvenueMap(props: Props) {
  return (
