...
const routeLabels: Record<string, string> = {
  ...
  "wall-washing-wall-cleaning": "Wall Washing",
  "wall-washing-wall-cleaning-calgary": "Wall Washing Calgary",
  "post-construction-cleaning-calgary": "Post Construction Calgary",
