  ...
  return (
    <ServiceDetailPage
      ...
      faqs={[
        ...
        { q: "How long does a standard cleaning take?", a: `A standard clean of a two-bedroom, one-bathroom apartment usually takes ${POLICY.typicalVisitLength?.standard}; a bigger home takes longer. The price is set by home size for the condition you describe; if the home needs much more work than that, we agree any extra charge with you before doing it. The booking gives an arrival window rather than an exact time: 9:00 to 10:00 AM, 12:00 to 1:00 PM, or 3:00 to 4:00 PM.` },
