...
const faqItems = [
  ...
  { value: "hidden-fees", question: "Are there any hidden fees?", answer: "Inside Edmonton and Calgary city limits there is no trip fee and no diagnostic fee. Addresses outside city limits carry a $29.99 travel fee, which you see on your quote before you book. Estimates are based on the details you give when booking; uncommon condition-based adjustments may apply if a home needs substantially more time or work than expected." },
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <Tabs defaultValue="standard" className="w-full">
              ...
              <TabsContent value="standard">
                <p className="text-center text-muted-foreground mb-8">Regular cleaning for your home</p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <PricingOptionCard
                ...
                description="Ideal for one-off cleaning needs or focusing on specific areas of your home. This flexible package lets you customize the cleaning by selecting only the areas you want done."
                price={`${formatPrice(HOURLY_RATE)}/hour`}
                priceLabel="Per cleaner"
                features={["Minimum booking: 1 cleaner for 3 hours or 2 cleaners for 2 hours", "Flexible and customizable", "Focus on your priority areas", "Pay only for time used", "Great for one-time needs"]}
