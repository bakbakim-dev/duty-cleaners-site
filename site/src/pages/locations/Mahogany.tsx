  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:description" content="Professional house cleaning in Mahogany, Calgary. Same-day service available. 100% satisfaction guaranteed." />
            ...
            <AnimatedSection>
              <div className="text-center mb-14">
                ...
                <p className="text-white/90 max-w-2xl mx-auto text-lg">
                  Trusted by families across SE Calgary for reliable, thorough, and non-toxic cleaning.
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection>
