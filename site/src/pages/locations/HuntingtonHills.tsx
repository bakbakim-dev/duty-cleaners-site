...
import featureImg from "@/assets/gallery/huntington-hills-cleaner.jpg";
...
export default function HuntingtonHills() {
  ...
  return (
    <>
      <Helmet>
        <title>House Cleaning Services in Huntington Hills, Calgary | Duty Cleaners</title>
            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <div className="text-muted-foreground space-y-4 text-lg leading-relaxed">
                  ...
                  <p>Whether you live in a classic split-level, a renovated family home, or a townhouse near Huntington Hills Plaza, we customize every clean to match your space and schedule — always with non-toxic products that are safe for kids and pets.</p>
                </div>
              </div>
            </AnimatedSection>
          </div>
