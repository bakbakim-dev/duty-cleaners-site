...
const services = [
  { icon: Home, title: "Standard Cleaning", description: "A thorough one-time cleaning that leaves your Huntington Hills home spotless and fresh.", to: "/calgary/regular-cleaning/", linkText: "Standard cleaning in Huntington Hills" },
  { icon: Sparkles, title: "Deep Cleaning", description: "Every corner, baseboard, and hidden surface, cleaned top to bottom.", to: "/calgary/deep-cleaning/", linkText: "Deep cleaning in Huntington Hills" },
  { icon: Truck, title: "Move In/Out Cleaning", description: "Detailed cleaning for a smooth Huntington Hills move — leave or arrive to a pristine home.", to: "/move-out-cleaning-calgary/", linkText: "Move-out cleaning in Huntington Hills" },
          ...
          <div className="container mx-auto px-4">
            ...
            <AnimatedSection>
              ...
              <p className="mt-10 text-center text-muted-foreground">
                {"Huntington Hills is one of the Calgary neighbourhoods we clean — see "}
                <Link
