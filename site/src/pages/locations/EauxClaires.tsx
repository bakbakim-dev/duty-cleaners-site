...
export default function EauxClaires() {
  return (
    <LocationPageTemplate
      ...
      description="Eaux Claires homes have more separate rooms than a modern open-plan build and more trim and sills to hand-wipe than their square footage suggests, so mention the layout as well as the bedroom count when you book. Pollen and leaf litter from the mature trees on its streets pack into window tracks and door channels."
