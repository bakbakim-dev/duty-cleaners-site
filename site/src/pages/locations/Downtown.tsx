              ...
              <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed text-lg">
                  ...
                  <p>
                    ...
                    steps from{" "}
                    <a href="https://www.google.com/maps/place/Ice+District+Edmonton" target="_blank" rel="noopener noreferrer" className="text-primary underline underline-offset-2">Ice District</a>,
                    close to{" "}
                    ...
                    or near{" "}
                    <a href="https://www.google.com/maps/place/Sir+Winston+Churchill+Square+Edmonton" target="_blank" rel="noopener noreferrer" className="text-primary underline underline-offset-2">Churchill Square</a>,
          ...
          <div className="container mx-auto px-4">
            ...
            <AnimatedSection>
              ...
              <p className="mt-10 text-center text-muted-foreground">
                {"Downtown Edmonton is one of the Edmonton neighbourhoods we clean — see "}
