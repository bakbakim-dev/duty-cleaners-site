...
import heroImg from "@/assets/gallery/downtown-cleaner.webp";
...
const services = [
  { icon: Home, title: "Standard Cleaning", description: "A thorough one-time cleaning to refresh your Downtown Edmonton home spotless and fresh year-round." },
  { icon: Sparkles, title: "Deep Cleaning", description: "Thorough top-to-bottom cleaning of your Downtown home — every corner, baseboard, and hidden surface." },
  { icon: Truck, title: "Move In/Out Cleaning", description: "Detailed cleaning for a smooth Downtown move — leave or arrive to a pristine home." },
  { icon: SprayCan, title: "Post-Construction Cleanup", description: "Expert dust and debris removal after renovations or new builds around Downtown." },
...
const whyUsItems = [
  ...
  { icon: Clock, title: "Flexible Scheduling", description: "Same-day and next-day availability in Downtown. We work around your busy life." },
...
export default function Downtown() {
  ...
  const faqs = [
    {
      ...
      answer: `We work to a checklist, not a clock. Your Downtown team stays until every task in your service scope is complete, and your flat rate does not change based on how long it takes.`
    },
    {
      question: "What cleaning services does Duty Cleaners offer in Downtown Edmonton?",
      answer: `Around Downtown we offer the full range:\n\n• Commercial Cleaning\n• Standard & Deep Cleaning Packages\n• Move-In & Move-Out Cleaning\n• Post-Construction Cleaning\n• Wall Washing and Wall Cleaning`
    },
    {
      question: "Do you offer discounts?",
      answer: `Yes — recurring Downtown customers save:\n\n• Every week: 20% off\n• Every two weeks: 15% off\n• Every four weeks: 10% off`
    },
    {
      question: "What's included in a deep cleaning?",
      answer: `A Downtown deep clean adds to the standard package:\n\n• Wall outlet covers wiped\n• Cobweb removal\n• Ceiling fans dusted and cleaned\n• Light switches fully cleaned\n• All reachable vents cleaned\n• And more!`
    },
    {
      question: "What is your 100% satisfaction guarantee policy?",
      answer: "If you're not 100% satisfied, call us within 24 hours and we'll come back to your Downtown home and make it right — at no extra cost!"
    }
  ];
  const faqJsonLd = {
  ...
  geo: { latitude: "53.5444", longitude: "-113.4909" },
        ...
        <meta property="og:title" content="House Cleaning in Downtown Edmonton | Duty Cleaners" />
        <meta property="og:description" content="Professional house cleaning in Downtown Edmonton. Trusted local cleaners serving Downtown Edmonton homes with reliable, customer-rated cleaning service." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://dutycleaners.ca/locations/downtown-edmonton/" />
        <meta property="og:image" content="https://dutycleaners.ca/og-image.jpg" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="House Cleaning in Downtown Edmonton | Duty Cleaners" />
        <meta name="twitter:description" content="Professional house cleaning in Downtown Edmonton. Trusted local cleaners serving Downtown Edmonton homes with reliable, customer-rated cleaning service." />
      </Helmet>
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-2 mb-6">Residential Cleaning in Downtown Edmonton</h2>
                <div className="space-y-4 text-muted-foreground leading-relaxed text-lg">
                  <p>Downtown Edmonton blends urban energy with great everyday living — high-rise condos, walkable streets and a buzzing food and arts scene. Whether you live near Rogers Place, in the Ice District, or in a beautifully renovated loft along Jasper Avenue, we make it easy to keep your space pristine.</p>
                  <p>
                    ...
                    steps from{" "}
                    <a href="https://www.google.com/maps/place/Ice+District+Edmonton" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Ice District</a>,
                    close to{" "}
                    ...
                    or near{" "}
                    <a href="https://www.google.com/maps/place/Sir+Winston+Churchill+Square+Edmonton" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Churchill Square</a>,
            ...
            <AnimatedSection>
              <div className="text-center mb-14">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
                  From routine upkeep to move-outs, Downtown homes get every service they need.
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection>
            ...
            <AnimatedSection>
              <div className="text-center mb-14">
                ...
                <p className="text-white/90 max-w-2xl mx-auto text-lg">
                  Trusted by Downtown families for reliable, thorough cleaning.
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection>
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            <AnimatedSection>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Ready for a Spotless Home in Downtown Edmonton?
              </h2>
