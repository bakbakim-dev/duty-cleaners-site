...
import cleanHomeImg from "@/assets/gallery/neighborhoods/lower-mount-royal.webp";
...
const services = [
  { icon: Home, title: "Standard Cleaning", description: "A thorough one-time cleaning that resets the whole home, room by room.", to: "/calgary/regular-cleaning/", linkText: "Standard cleaning in Lower Mount Royal" },
  { icon: Sparkles, title: "Deep Cleaning", description: "Thorough top-to-bottom cleaning of your Lower Mount Royal home — every corner, baseboard, and hidden surface.", to: "/calgary/deep-cleaning/", linkText: "Deep cleaning in Lower Mount Royal" },
  { icon: Truck, title: "Move In/Out Cleaning", description: "Inspection-grade detail for moving out or settling in.", to: "/move-out-cleaning-calgary/", linkText: "Move-out cleaning in Lower Mount Royal" },
...
const landmarks = [
  {
    ...
    "description": "The heart of Calgary's dining and nightlife scene"
  },
  {
    "title": "Tomkins Park",
    "url": "https://www.google.com/maps/place/Tomkins+Park,+Calgary,+AB/",
    "description": "Lively pocket park hosting summer events"
  },
  {
    "title": "Mount Royal Village",
    "url": "https://www.google.com/maps/place/Mount+Royal+Village,+Calgary,+AB/",
    "description": "Boutique shopping and local cafés"
  },
  {
    "title": "Western Canada High School",
    "url": "https://www.google.com/maps/place/Western+Canada+High+School,+Calgary,+AB/",
    "description": "Historic school and community landmark"
  }
];

const nearbyAreas = ["Mount Royal","Beltline","Cliff Bungalow","Mission","Bankview","Sunalta"];
...
const faqs = [
  ...
  },
  {
    ...
    answer: "If you're not 100% satisfied, call us within 24 hours and we'll come back to your Lower Mount Royal home and make it right — at no extra cost!"
  }
];

const structuredData = buildLocationSchema({
  name: "Duty Cleaners - Lower Mount Royal Calgary",
  city: "calgary",
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-5 py-2 mb-6">
                ...
                <span className="text-white/90 text-sm font-medium">Serving Lower Mount Royal, SW Calgary</span>
              </div>
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-2 mb-6">Cleaning Services Tailored to Lower Mount Royal Living</h2>
          ...
          <div className="container mx-auto px-4">
            ...
            <AnimatedSection>
              ...
              <p className="mt-10 text-center text-muted-foreground">
                {"Lower Mount Royal is one of the Calgary neighbourhoods we clean — see "}
                <Link
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="text-center mb-14 max-w-3xl mx-auto">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-2 mb-4">Around Lower Mount Royal</h2>
                <p className="text-muted-foreground text-lg">
                  We know the area inside and out — here are a few of the places that make Lower Mount Royal feel like home.
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection>
            ...
            <AnimatedSection>
              <div className="max-w-5xl mx-auto">
                ...
                <div className="rounded-2xl overflow-hidden shadow-xl border border-border">
                  <iframe
                    src="https://www.google.com/maps?q=Lower+Mount+Royal,+Calgary,+AB&output=embed"
                    width="100%"
                    height="450"
                    style={{ border: 0 }}
                    allowFullScreen
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="text-center mb-10">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto">
                  We proudly serve families and homeowners across Lower Mount Royal and surrounding SW Calgary communities.
                </p>
              </div>
      ...
      <LocationPricing />
            ...
            <AnimatedSection>
              <div className="text-center mb-14">
                ...
                <p className="text-white/90 max-w-2xl mx-auto text-lg">
                  Trusted by Lower Mount Royal families for reliable, thorough cleaning.
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection>
        ...
        <section className="py-20 bg-brand-navy relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            <AnimatedSection>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Ready for a Spotless Home in Lower Mount Royal?</h2>
