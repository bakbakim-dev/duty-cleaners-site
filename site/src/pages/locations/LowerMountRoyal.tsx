...
import cleanHomeImg from "@/assets/gallery/neighborhoods/lower-mount-royal.jpg";
...
export default function LowerMountRoyal() {
  ...
  return (
    <>
      <Helmet>
        <title>House Cleaning Services in Lower Mount Royal, Calgary | Duty Cleaners</title>
        <meta name="description" content="Professional house cleaning in Lower Mount Royal, Calgary. Same-day service available. 100% satisfaction guaranteed. Pay after your clean. Get a free quote today!" />
        <meta property="og:title" content="House Cleaning Services Lower Mount Royal Calgary | Duty Cleaners" />
        <meta property="og:description" content="Professional house cleaning in Lower Mount Royal, Calgary. Same-day service available. 100% satisfaction guaranteed." />
