...
import featureImg from "@/assets/gallery/ogden-bathroom-clean.jpg";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional house cleaning in Ogden, Calgary. Same-day service available. 100% satisfaction guaranteed. Pay after your clean. Get a free quote today!" />
        <meta property="og:title" content="House Cleaning Services Ogden Calgary | Duty Cleaners" />
        <meta property="og:description" content="Professional house cleaning in Ogden, Calgary. Same-day service available. 100% satisfaction guaranteed." />
            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <div className="text-muted-foreground space-y-4 text-lg leading-relaxed">
                  ...
                  <p>We bring our own non-toxic supplies, our own equipment, and a quiet attention to detail that turns a clean home into a calm one. No upselling, no rushed work — just the kind of service Ogden families have come to count on.</p>
                </div>
              </div>
            </AnimatedSection>
          </div>
