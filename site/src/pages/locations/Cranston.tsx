...
const whyUsItems = [
  ...
  { icon: Clock, title: "Flexible Scheduling", description: "Same-day and next-day availability. We work around your busy family life." },
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:description" content="Professional house cleaning in Cranston, Calgary. Same-day service available. 100% satisfaction guaranteed." />
      ...
      <div className="min-h-screen">
            ...
            <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
              <div className="flex-1 text-center lg:text-left">
                <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-5 py-2 mb-6">
                  ...
                  <span className="text-white/90 text-sm font-medium">Serving Cranston, Calgary</span>
                </div>
              ...
              <div className="flex-shrink-0 w-full lg:w-[500px]">
                <img
                  ...
                  alt="Beautiful family home in Cranston Calgary community"
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-2 mb-6">Cleaning Services Tailored to Cranston Living</h2>
                <div className="text-muted-foreground space-y-4 text-lg leading-relaxed">
                  ...
                  <p>
                    ...
                    we provide flexible scheduling and non-toxic cleaning solutions suited to every household.
                  </p>
                </div>
              </div>
            </AnimatedSection>
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <h2 className="text-3xl font-bold text-foreground mt-2 mb-6">Cranston Service Area</h2>
                <div className="rounded-2xl overflow-hidden shadow-xl">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d10040.0!2d-114.0167!3d50.9017!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x537177c3d0a1e0a7%3A0x1b0d1e1e1e1e1e1e!2sCranston%2C+Calgary%2C+AB!5e0!3m2!1sen!2sca!4v1700000000000"
                    width="100%" height="450" style={{ border: 0 }} allowFullScreen loading="lazy"
                    referrerPolicy="no-referrer-when-downgrade" title="Cranston Service Area Map"
                  />
                </div>
              </div>
            </AnimatedSection>
        ...
        <section className="py-20 bg-brand-navy relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            <AnimatedSection>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Ready for a Spotless Home in Cranston?</h2>
