...
const services = [
  ...
  { icon: Sparkles, title: "Deep Cleaning", description: "A deep clean is the standard checklist plus the deep-clean package: baseboards, doors, light switches, wall outlets and vent covers.", to: "/edmonton/deep-cleaning/", linkText: "Deep cleaning in Brintnell" },
  ...
  { icon: CalendarCheck, title: "Recurring Cleaning", description: `The standard checklist on a schedule, from ${RECURRING_FROM} a visit for a one-bedroom, one-bathroom apartment, before 5% GST and any pet or home-type charge. From the second clean on, weekly takes ${OFF_WEEKLY} off, every two weeks ${OFF_BIWEEKLY} and every four weeks ${OFF_FOUR_WEEKLY}.`, to: "/edmonton/recurring-cleaning/", linkText: "Recurring cleaning in Brintnell" },
];
...
export default function Brintnell() {
  ...
  geo: { latitude: "53.621", longitude: "-113.405" },
            ...
            <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12">
              <div className="flex-1 text-center lg:text-left">
                ...
                <p className="text-lg md:text-xl text-white/80 mb-10 max-w-3xl leading-relaxed">
                  Brintnell is one of northeast Edmonton's 2000s-era neighbourhoods, with open-plan main floors and two-storey great rooms. Our Edmonton branch cleans these homes at a flat rate by home size.
                </p>
              ...
              <div className="lg:w-[500px] flex-shrink-0">
                <img
                  src={heroImg}
                  alt="Cleaner in blue gloves wiping a granite kitchen island"
            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto text-center mb-10">
                ...
                <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                  Brintnell is in northeast Edmonton, and homes near the Manning Drive retail pick up delivery-traffic grit at the front walk.
                </p>
              </div>
            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                <div className="text-center mb-10">
                  ...
                  <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                    Brintnell is on our Edmonton branch's list of 80 neighbourhoods, alongside nine communities outside the city such as Fort Saskatchewan and St. Albert.
                  </p>
                </div>
                <CoverageChips areas={["Hollick-Kenyon", "Casselman", "Matt Berry", "McConachie"]} variant="compact" />
      ...
      <LocalMarketNote
        ...
        heading="What Brintnell homes need"
        paragraphs={[
          ...
          "Homes near the retail on Manning Drive add delivery-traffic grit at the front walk.",
        ]}
      />
