...
import heroImg from "@/assets/gallery/eastwood-cleaner.webp";
...
const services = [
  { icon: Home, title: "Standard Cleaning", description: "A thorough one-time cleaning to bring the whole home back to baseline.", to: "/edmonton/regular-cleaning/", linkText: "Standard cleaning in Eastwood" },
  { icon: Sparkles, title: "Deep Cleaning", description: "Thorough top-to-bottom cleaning of your Eastwood home — every corner, baseboard, and hidden surface.", to: "/edmonton/deep-cleaning/", linkText: "Deep cleaning in Eastwood" },
  { icon: Truck, title: "Move In/Out Cleaning", description: "Move-day cleaning done to the standard landlords check for.", to: "/move-out-cleaning-edmonton/", linkText: "Move-out cleaning in Eastwood" },
  ...
  const faqs = [
    {
      ...
      answer: `We work to a checklist, not a clock. Your Eastwood team stays until every task in your service scope is complete, and your flat rate does not change based on how long it takes.`
    },
    {
    ...
    },
    {
      ...
      answer: "If you're not 100% satisfied, call us within 24 hours and we'll come back to your Eastwood home and make it right — at no extra cost!"
    }
  ];
  const faqJsonLd = {
            ...
            <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12">
              <div className="flex-1 text-center lg:text-left">
                <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-5 py-2 mb-6">
                  ...
                  <span className="text-white/90 text-sm font-medium">Serving Eastwood, Edmonton</span>
                </div>
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-2 mb-6">Residential Cleaning in Eastwood</h2>
          ...
          <div className="container mx-auto px-4">
            ...
            <AnimatedSection>
              ...
              <p className="mt-10 text-center text-muted-foreground">
                {"Eastwood is one of the Edmonton neighbourhoods we clean — see "}
            ...
            <AnimatedSection>
              ...
              <div className="max-w-4xl mx-auto rounded-2xl overflow-hidden shadow-lg border border-border">
                <Suspense fallback={<div className="w-full h-[400px] bg-muted animate-pulse rounded-2xl" />}>
                  <LocationMap center={[53.571, -113.463]} label="Eastwood, Edmonton" />
                </Suspense>
              </div>
            </AnimatedSection>
          </div>
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            <AnimatedSection>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Ready for a Spotless Home in Eastwood?
              </h2>
