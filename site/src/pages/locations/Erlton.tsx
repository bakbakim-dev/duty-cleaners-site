...
import cleanHomeImg from "@/assets/gallery/neighborhoods/erlton.webp";
...
const services = [
  { icon: Home, title: "Standard Cleaning", description: "A thorough one-time cleaning that leaves your Erlton home spotless and fresh.", to: "/calgary/regular-cleaning/", linkText: "Standard cleaning in Erlton" },
  { icon: Sparkles, title: "Deep Cleaning", description: "Top-to-bottom detail that reaches what weekly cleaning never does.", to: "/calgary/deep-cleaning/", linkText: "Deep cleaning in Erlton" },
  { icon: Truck, title: "Move In/Out Cleaning", description: "Detailed cleaning for moving day — leave or arrive to a pristine home.", to: "/move-out-cleaning-calgary/", linkText: "Move-out cleaning in Erlton" },
...
const whyUsItems = [
  ...
  { icon: Clock, title: "Flexible Scheduling", description: "Same-day and next-day availability in Erlton. We work around your busy life." },
...
const landmarks = [
  {
    ...
    "description": "Scenic riverside trails for walking and cycling"
  },
  {
    "title": "Erlton/Stampede C-Train Station",
    "url": "https://www.google.com/maps/place/Erlton+Stampede+CTrain+Station,+Calgary,+AB/",
    "description": "Direct LRT link to downtown and beyond"
  },
  {
    "title": "Lindsay Park / MNP Sport Centre",
    "url": "https://www.google.com/maps/place/MNP+Community+Sport+Centre,+Calgary,+AB/",
    "description": "Major recreation and aquatic facility"
  },
  {
    "title": "Stampede Park",
    "url": "https://www.google.com/maps/place/Stampede+Park,+Calgary,+AB/",
    "description": "World-famous Stampede grounds next door"
  }
];

const nearbyAreas = ["Mission","Cliff Bungalow","Ramsay","Victoria Park","Beltline","Roxboro"];
...
const structuredData = buildLocationSchema({
  name: "Duty Cleaners - Erlton Calgary",
  city: "calgary",
  url: "https://dutycleaners.ca/locations/erlton-calgary",
  priceRange: "$155-$539",
  geo: { latitude: "51.0335", longitude: "-114.0660" },
});
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-5 py-2 mb-6">
                ...
                <span className="text-white/90 text-sm font-medium">Serving Erlton, SW Calgary</span>
              </div>
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-2 mb-6">Cleaning Services Tailored to Erlton Living</h2>
          ...
          <div className="container mx-auto px-4">
            ...
            <AnimatedSection>
              ...
              <p className="mt-10 text-center text-muted-foreground">
                {"Erlton is one of the Calgary neighbourhoods we clean — see "}
                <Link
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="text-center mb-14 max-w-3xl mx-auto">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-2 mb-4">Around Erlton</h2>
                <p className="text-muted-foreground text-lg">
                  We know the area inside and out — here are a few of the places that make Erlton feel like home.
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection>
            ...
            <AnimatedSection>
              <div className="max-w-5xl mx-auto">
                ...
                <div className="rounded-2xl overflow-hidden shadow-xl border border-border">
                  <iframe
                    src="https://www.google.com/maps?q=Erlton,+Calgary,+AB&output=embed"
                    width="100%"
                    height="450"
                    style={{ border: 0 }}
                    allowFullScreen
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="text-center mb-10">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto">
                  We proudly serve families and homeowners across Erlton and surrounding SW Calgary communities.
                </p>
              </div>
      ...
      <LocationPricing />
        ...
        <section className="py-20 bg-brand-navy relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            <AnimatedSection>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Ready for a Spotless Home in Erlton?</h2>
