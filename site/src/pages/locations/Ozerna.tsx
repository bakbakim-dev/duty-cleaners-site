...
const services = [
  { icon: Home, title: "Standard Cleaning", description: "A thorough one-time cleaning to bring the whole home back to baseline.", to: "/edmonton/regular-cleaning/", linkText: "Standard cleaning in Ozerna" },
  { icon: Sparkles, title: "Deep Cleaning", description: "Every corner, baseboard, and hidden surface, cleaned top to bottom.", to: "/edmonton/deep-cleaning/", linkText: "Deep cleaning in Ozerna" },
  { icon: Truck, title: "Move In/Out Cleaning", description: "Detailed cleaning for moving day — leave or arrive to a pristine home.", to: "/move-out-cleaning-edmonton/", linkText: "Move-out cleaning in Ozerna" },
...
export default function Ozerna() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  const faqs = [
    ...
    {
      question: "What cleaning services does Duty Cleaners offer in Ozerna?",
            ...
            <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12">
              <div className="flex-1 text-center lg:text-left">
                <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-5 py-2 mb-6">
                  ...
                  <span className="text-white/90 text-sm font-medium">Serving Ozerna, Edmonton</span>
                </div>
            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed text-lg">
                  <p>
                    Ozerna sits in Edmonton's Lake District, built around a stormwater lake with walking paths circling it. Living beside standing water raises humidity through the warm months, and indoors that means bathrooms and ensuites hold moisture longer between uses — the grout at the base of the shower and the seal around the tub are where it shows first, and they are the two places a standard wipe-down never reaches. The people who live here take pride in their homes, and at Duty Cleaners, we're proud to be part of the rhythm of daily life in Ozerna.
                  </p>
                  <p>
                    Whether your home is near{" "}
                    <a href="https://www.google.com/maps/search/Ozerna+Park+Edmonton/" target="_blank" rel="noopener noreferrer" className="text-primary underline underline-offset-2">Ozerna Park</a>,
                    steps from <a href="https://www.google.com/maps/place/Manning+Dr,+Edmonton,+AB/" target="_blank" rel="noopener noreferrer" className="text-primary underline underline-offset-2">Manning Drive</a>,
                    minutes from <a href="https://www.google.com/maps/place/153+Ave+NW,+Edmonton,+AB/" target="_blank" rel="noopener noreferrer" className="text-primary underline underline-offset-2">153 Avenue</a>,
                    or close to <a href="https://www.google.com/maps/place/Manning+Town+Centre/" target="_blank" rel="noopener noreferrer" className="text-primary underline underline-offset-2">Manning Town Centre</a>,
          ...
          <div className="container mx-auto px-4">
            ...
            <AnimatedSection>
              ...
              <p className="mt-10 text-center text-muted-foreground">
                {"Ozerna is one of the Edmonton neighbourhoods we clean — see "}
            ...
            <AnimatedSection>
              <div className="text-center mb-14">
                ...
                <p className="text-white/90 max-w-2xl mx-auto text-lg">
                  Trusted by Ozerna families for reliable, thorough cleaning.
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection>
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            <AnimatedSection>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Ready for a Spotless Home in Ozerna?
              </h2>
