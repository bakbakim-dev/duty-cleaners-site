...
const services = [
  ...
  { icon: Sparkles, title: "Deep Cleaning", description: "The standard checklist plus the deep-clean package: cobwebs, ceiling fans, light switches, outlet covers and vent covers.", to: "/edmonton/deep-cleaning/", linkText: "Deep cleaning in Leduc" },
        ...
        <div className="container mx-auto px-4">
          <AnimatedSection>
            <div className="max-w-3xl mx-auto">
              ...
              <div className="text-muted-foreground text-lg leading-relaxed space-y-4">
                <p>
                  For a home that is kept up, the standard clean holds it, from {STANDARD_FROM} for a one-bedroom apartment or condo, before GST, the travel fee and any house-type or pet surcharge, and it can go on a repeating schedule. The deep clean, from {DEEP_FROM} on the same terms, adds cobwebs, ceiling fans, light switches, outlet covers and vent covers to the standard checklist, which makes it the better first visit for a home that has not had a professional clean.
                </p>
                <p>
                  For a handover, book{" "}
