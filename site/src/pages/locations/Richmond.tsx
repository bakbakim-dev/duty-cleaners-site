...
import cleanHomeImg from "@/assets/gallery/neighborhoods/richmond.webp";
...
const services = [
  { icon: Home, title: "Standard Cleaning", description: "A thorough one-time cleaning that resets the whole home, room by room.", to: "/calgary/regular-cleaning/", linkText: "Standard cleaning in Richmond" },
  { icon: Sparkles, title: "Deep Cleaning", description: "Thorough top-to-bottom cleaning of your Richmond home — every corner, baseboard, and hidden surface.", to: "/calgary/deep-cleaning/", linkText: "Deep cleaning in Richmond" },
  { icon: Truck, title: "Move In/Out Cleaning", description: "Detailed cleaning for a smooth Richmond move — leave or arrive to a pristine home.", to: "/move-out-cleaning-calgary/", linkText: "Move-out cleaning in Richmond" },
  ...
  { icon: Building2, title: "Commercial Cleaning", description: "Professional office and commercial space cleaning for Richmond businesses of all sizes." },
];
...
const whyUsItems = [
  ...
  { icon: Clock, title: "Flexible Scheduling", description: "Same-day and next-day availability in Richmond. We work around your busy life." },
...
const landmarks = [
  {
    ...
    "url": "https://www.google.com/maps/place/Richmond+Green+Park,+Calgary,+AB/",
    "description": "Sports fields, off-leash area, and toboggan hill"
  },
  {
    "title": "Marda Loop Shops",
    "url": "https://www.google.com/maps/place/Marda+Loop,+Calgary,+AB/",
    "description": "Trendy boutiques and restaurants nearby"
  },
  {
    "title": "Sandy Beach Park",
    "url": "https://www.google.com/maps/place/Sandy+Beach+Park,+Calgary,+AB/",
    "description": "Riverside picnic spot along the Elbow"
  },
  {
    "title": "Mount Royal University",
    "url": "https://www.google.com/maps/place/Mount+Royal+University,+Calgary,+AB/",
    "description": "Major post-secondary campus a short drive south"
  }
];
...
const faqs = [
  ...
  },
  {
    ...
    answer: "If you're not 100% satisfied, call us within 24 hours and we'll come back to your Richmond home and make it right — at no extra cost!"
  }
];
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-5 py-2 mb-6">
                ...
                <span className="text-white/90 text-sm font-medium">Serving Richmond, Calgary</span>
              </div>
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="text-center mb-14 max-w-3xl mx-auto">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-2 mb-4">Around Richmond</h2>
                <p className="text-muted-foreground text-lg">
                  We know the area inside and out — here are a few of the places that make Richmond feel like home.
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection>
            ...
            <AnimatedSection>
              <div className="max-w-5xl mx-auto">
                ...
                <div className="rounded-2xl overflow-hidden shadow-xl border border-border">
                  <iframe
                    src="https://www.google.com/maps?q=Richmond%2C%20Calgary%2C%20AB&output=embed"
                    width="100%"
                    height="450"
                    style={{ border: 0 }}
                    allowFullScreen
                    ...
                    title="Richmond Calgary Service Area Map"
                  />
                </div>
              </div>
            </AnimatedSection>
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="text-center mb-10">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto">
                  We proudly serve families and homeowners across Richmond and surrounding Calgary communities.
                </p>
              </div>
      ...
      <LocationPricing />
        ...
        <section className="py-20 bg-brand-navy relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            <AnimatedSection>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Ready for a Spotless Home in Richmond?</h2>
