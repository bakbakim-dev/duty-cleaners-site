...
import heroImg from "@/assets/gallery/belvedere-cleaner.webp";
...
const services = [
  { icon: Home, title: "Standard Cleaning", description: "A one-time clean of every room, priced flat by home size.", to: "/edmonton/regular-cleaning/", linkText: "Standard cleaning in Belvedere" },
  { icon: Sparkles, title: "Deep Cleaning", description: "The standard checklist plus the deep-clean package: cobwebs, ceiling fan blades within reach, light switches, outlet covers and vent covers.", to: "/edmonton/deep-cleaning/", linkText: "Deep cleaning in Belvedere" },
  { icon: Truck, title: "Move In/Out Cleaning", description: "Inside the oven, fridge and microwave, and inside every cabinet, drawer and closet.", to: "/move-out-cleaning-edmonton/", linkText: "Move-out cleaning in Belvedere" },
  { icon: SprayCan, title: "Post-Construction Cleanup", description: "Construction dust cleared after a renovation or a new build, priced by square footage.", to: "/post-construction-cleaning/", linkText: "Post-construction cleaning in Belvedere" },
  { icon: PaintRoller, title: "Wall Washing", description: "Scuffs, handprints and cooking film off painted walls, without stripping the finish.", to: "/wall-washing-wall-cleaning/", linkText: "Wall washing in Belvedere" },
  ...
  { icon: CalendarCheck, title: "Recurring Cleaning", description: `The standard checklist on a schedule, from ${RECURRING_FROM} a visit for a one-bedroom, one-bathroom apartment or condo, before GST and any pet or home-type charge. From the second clean on, weekly takes ${OFF_WEEKLY} off, every two weeks ${OFF_BIWEEKLY} and every four weeks ${OFF_FOUR_WEEKLY}.`, to: "/edmonton/recurring-cleaning/", linkText: "Recurring cleaning in Belvedere" },
];
...
export default function Belvedere() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Tell us within 24 hours and the team comes back to your Belvedere home to re-clean what was missed, at no charge. Photos help but are not required."
    }
  ];
  const faqJsonLd = {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Belvedere, Edmonton house cleaning beside the CN tracks and LRT stop, where fine dark dust shows on pale sills within days." />
  ...
  geo: { latitude: "53.581", longitude: "-113.425" },
        ...
        <meta property="og:description" content="Belvedere, Edmonton house cleaning beside the CN tracks and LRT stop, where fine dark dust shows on pale sills within days." />
        ...
        <meta name="twitter:description" content="Belvedere, Edmonton house cleaning beside the CN tracks and LRT stop, where fine dark dust shows on pale sills within days." />
      </Helmet>
            ...
            <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12">
              <div className="flex-1 text-center lg:text-left">
                <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-5 py-2 mb-6">
                  ...
                  <span className="text-white/90 text-sm font-medium">Serving Belvedere, Edmonton</span>
                </div>
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
                  Professional House Cleaning in Belvedere
                </h1>
                <p className="text-lg md:text-xl text-white/80 mb-10 max-w-3xl leading-relaxed">
                  Belvedere's 1950s-60s homes sit along the CN corridor and the Belvedere LRT stop. On the blocks nearest the tracks, fine dark dust shows on pale sills within days; two streets in, it fades to normal.
                </p>
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="text-center mb-14">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
                  Belvedere homes get a flat price by size, before GST, on standard, deep, move-out and recurring cleans; post-construction is quoted by square footage, and wall washing is added to one of those cleans.
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection>
            ...
            <AnimatedSection>
              ...
              <p className="mt-10 text-center text-muted-foreground">
                {"Belvedere is one of the Edmonton neighbourhoods we clean — see "}
            ...
            <AnimatedSection>
              <div className="text-center mb-14">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-white mt-2 mb-4">
                  Why Belvedere Residents Choose Duty Cleaners
                </h2>
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="max-w-4xl mx-auto text-center mb-10">
                ...
                <h2 className="text-3xl font-bold text-foreground mt-2 mb-4">Serving the Belvedere Area</h2>
                <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                  Belvedere lies inside Edmonton city limits along the CN corridor, so a quote here has no trip fee.
                </p>
              </div>
            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                <div className="text-center mb-10">
                  ...
                  <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                    Beacon Heights, Abbottsfield and Kildare are on the same Edmonton branch list, each with a page of its own.
                  </p>
                </div>
                <CoverageChips areas={["Beacon Heights", "Abbottsfield", "Kildare"]} variant="compact" />
      ...
      <LocalMarketNote
        ...
        paragraphs={[
          "Belvedere's 1950s-60s homes sit alongside the CN corridor and the Belvedere LRT stop, and rail-adjacent living has a specific indoor signature: fine dark dust that shows on pale sills and glossy furniture within days. The homes nearest the tracks get the most of it; two streets in, the effect fades to normal.",
          "The stock itself is compact post-war with original hardwood common under later flooring, and Fort Road's revitalisation keeps construction cycles coming to the area's spine. Transit-oriented redevelopment around the station adds periodic site dust to the east blocks.",
        ]}
      />
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            <AnimatedSection>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Ready to Book a Clean in Belvedere?
              </h2>
