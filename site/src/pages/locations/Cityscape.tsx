...
const services = [
  { icon: Home, title: "Standard Cleaning", description: "A thorough one-time cleaning to bring the whole home back to baseline.", to: "/calgary/regular-cleaning/", linkText: "Standard cleaning in Cityscape" },
  { icon: Sparkles, title: "Deep Cleaning", description: "A full top-to-bottom reset — corners, baseboards, and the surfaces regular visits skip.", to: "/calgary/deep-cleaning/", linkText: "Deep cleaning in Cityscape" },
  { icon: Truck, title: "Move In/Out Cleaning", description: "Move-day cleaning done to the standard landlords check for.", to: "/move-out-cleaning-calgary/", linkText: "Move-out cleaning in Cityscape" },
...
const faqs = [
  ...
  },
  {
    ...
    answer: `Yes — customers in Cityscape on a recurring schedule save:\n\n• Every week: 20% off\n• Every two weeks: 15% off\n• Every four weeks: 10% off`
  },
  {
          ...
          <div className="container mx-auto px-4">
            ...
            <AnimatedSection>
              ...
              <p className="mt-10 text-center text-muted-foreground">
                {"Cityscape is one of the Calgary neighbourhoods we clean — see "}
                <Link
