...
import heroImg from "@/assets/gallery/abbottsfield-cleaner.jpg";
...
export default function Abbottsfield() {
  ...
  return (
    <>
      <Helmet>
        <title>House Cleaning in Abbottsfield, Edmonton | Duty Cleaners</title>
  ...
  description: "Professional house cleaning services in Abbottsfield, Edmonton.",
}))}
        </script>
        <link rel="canonical" href="https://dutycleaners.ca/locations/abbottsfield-edmonton/" />
        <meta property="og:title" content="House Cleaning in Abbottsfield, Edmonton | Duty Cleaners" />
        ...
        <meta name="twitter:title" content="House Cleaning in Abbottsfield, Edmonton | Duty Cleaners" />
