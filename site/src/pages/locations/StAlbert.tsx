...
import stAlbertLandmark from "@/assets/gallery/st-albert-landmark.jpg";
          ...
          <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-10">
            <div className="flex-1 text-center lg:text-left">
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-5 py-2 mb-6">
                ...
                <span className="text-white/90 text-sm font-medium">Serving St. Albert, Edmonton</span>
              </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="prose prose-lg text-muted-foreground max-w-none space-y-4">
                ...
                <p>
                  ...
                  deserve a home that's just as clean and inviting as the community around them. We bring non-toxic products and meticulous attention to detail to every St. Albert home we service.
                </p>
              </div>
            </div>
          </AnimatedSection>
