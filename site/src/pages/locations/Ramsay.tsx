...
import cleanHomeImg from "@/assets/gallery/neighborhoods/ramsay.webp";
...
const services = [
  { icon: Home, title: "Standard Cleaning", description: "A thorough one-time cleaning that resets the whole home, room by room.", to: "/calgary/regular-cleaning/", linkText: "Standard cleaning in Ramsay" },
  { icon: Sparkles, title: "Deep Cleaning", description: "Thorough top-to-bottom cleaning of your Ramsay home — every corner, baseboard, and hidden surface.", to: "/calgary/deep-cleaning/", linkText: "Deep cleaning in Ramsay" },
  { icon: Truck, title: "Move In/Out Cleaning", description: "Detailed cleaning for a smooth Ramsay move — leave or arrive to a pristine home.", to: "/move-out-cleaning-calgary/", linkText: "Move-out cleaning in Ramsay" },
  ...
  { icon: Building2, title: "Commercial Cleaning", description: "Professional office and commercial space cleaning for Ramsay businesses of all sizes." },
];
...
const whyUsItems = [
  ...
  { icon: Clock, title: "Flexible Scheduling", description: "Same-day and next-day availability in Ramsay. We work around your busy life." },
...
const landmarks = [
  {
    "title": "Scotsman's Hill",
    "url": "https://www.google.com/maps/place/Scotsmans+Hill,+Calgary,+AB/",
    "description": "Iconic lookout over the Stampede grounds and skyline"
  },
  {
    "title": "Stampede Park",
    "url": "https://www.google.com/maps/place/Stampede+Park,+Calgary,+AB/",
    "description": "Home of the Calgary Stampede, just across the tracks"
  },
  {
    "title": "Inglewood Bird Sanctuary",
    "url": "https://www.google.com/maps/place/Inglewood+Bird+Sanctuary,+Calgary,+AB/",
    "description": "Riverside nature reserve nearby"
  },
  {
    "title": "Crossroads Market",
    "url": "https://www.google.com/maps/place/Crossroads+Farmers+Market,+Calgary,+AB/",
    "description": "Beloved indoor market with local vendors"
  }
];

const nearbyAreas = ["Inglewood","Erlton","Victoria Park","Mission","Crescent Heights","East Village"];
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-5 py-2 mb-6">
                ...
                <span className="text-white/90 text-sm font-medium">Serving Ramsay, SE Calgary</span>
              </div>
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-2 mb-6">Cleaning Services Tailored to Ramsay Living</h2>
          ...
          <div className="container mx-auto px-4">
            ...
            <AnimatedSection>
              ...
              <p className="mt-10 text-center text-muted-foreground">
                {"Ramsay is one of the Calgary neighbourhoods we clean — see "}
                <Link
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="text-center mb-14 max-w-3xl mx-auto">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-2 mb-4">Around Ramsay</h2>
                <p className="text-muted-foreground text-lg">
                  We know the area inside and out — here are a few of the places that make Ramsay feel like home.
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection>
            ...
            <AnimatedSection>
              <div className="max-w-5xl mx-auto">
                ...
                <div className="rounded-2xl overflow-hidden shadow-xl border border-border">
                  <iframe
                    src="https://www.google.com/maps?q=Ramsay,+Calgary,+AB&output=embed"
                    width="100%"
                    height="450"
                    style={{ border: 0 }}
                    allowFullScreen
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="text-center mb-10">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto">
                  We proudly serve families and homeowners across Ramsay and surrounding SE Calgary communities.
                </p>
              </div>
      ...
      <LocationPricing />
        ...
        <section className="py-20 bg-brand-navy relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            <AnimatedSection>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Ready for a Spotless Home in Ramsay?</h2>
