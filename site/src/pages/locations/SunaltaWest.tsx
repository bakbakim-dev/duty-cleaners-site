...
import cleanHomeImg from "@/assets/gallery/neighborhoods/sunalta-west.jpg";
...
export default function SunaltaWest() {
  ...
  return (
    <>
      <Helmet>
        <title>House Cleaning Services in Sunalta West, Calgary | Duty Cleaners</title>
            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <div className="text-muted-foreground space-y-4 text-lg leading-relaxed">
                  ...
                  <p>Whether your space is a sleek new condo, a renovated bungalow, or a busy family home, our cleaners adapt to your routine and use non-toxic products that are safe for everyone — including pets.</p>
                </div>
              </div>
            </AnimatedSection>
          </div>
