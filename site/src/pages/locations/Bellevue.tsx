  ...
  const faqJsonLd = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: { "@type": "Answer", text: "Yes. We use safe, effective products that are appropriate for homes with pets and children, so you can feel confident about your family's well-being." },
      },
    ],
  };
              ...
              <div className="max-w-3xl mx-auto">
                ...
                <Accordion type="single" collapsible className="w-full">
                  ...
                  <AccordionItem value="item-3">
                    ...
                    <AccordionContent>Yes. We use safe, effective products that are appropriate for homes with pets and children, so you can feel confident about your family's well-being.</AccordionContent>
                  </AccordionItem>
                </Accordion>
              </div>
            </AnimatedSection>
