...
import heroImg from "@/assets/gallery/boyle-street-cleaner.webp";
...
const services = [
  { icon: Home, title: "Standard Cleaning", description: "A thorough one-time cleaning to refresh your Boyle Street home spotless and fresh year-round." },
  { icon: Sparkles, title: "Deep Cleaning", description: "Thorough top-to-bottom cleaning of your Boyle Street home — every corner, baseboard, and hidden surface." },
  { icon: Truck, title: "Move In/Out Cleaning", description: "Detailed cleaning for a smooth Boyle Street move — leave or arrive to a pristine home." },
  { icon: SprayCan, title: "Post-Construction Cleanup", description: "Expert dust and debris removal after renovations or new builds around Boyle Street." },
...
const whyUsItems = [
  ...
  { icon: Clock, title: "Flexible Scheduling", description: "Same-day and next-day availability in Boyle Street. We work around your busy life." },
...
export default function BoyleStreet() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  const faqs = [
    {
      ...
      answer: `We work to a checklist, not a clock. Your Boyle Street team stays until every task in your service scope is complete, and your flat rate does not change based on how long it takes.`
    },
    {
      question: "What cleaning services does Duty Cleaners offer in Boyle Street?",
      answer: `Around Boyle Street we offer the full range:\n\n• Commercial Cleaning\n• Standard & Deep Cleaning Packages\n• Move-In & Move-Out Cleaning\n• Post-Construction Cleaning\n• Wall Washing and Wall Cleaning`
    },
    {
      question: "Do you offer discounts?",
      answer: `Yes — recurring Boyle Street customers save:\n\n• Every week: 20% off\n• Every two weeks: 15% off\n• Every four weeks: 10% off`
    },
    {
      question: "What's included in a deep cleaning?",
      answer: `A Boyle Street deep clean adds to the standard package:\n\n• Wall outlet covers wiped\n• Cobweb removal\n• Ceiling fans dusted and cleaned\n• Light switches fully cleaned\n• All reachable vents cleaned\n• And more!`
    },
    {
      question: "What is your 100% satisfaction guarantee policy?",
      answer: "If you're not 100% satisfied, call us within 24 hours and we'll come back to your Boyle Street home and make it right — at no extra cost!"
    }
  ];
  const faqJsonLd = {
  ...
  return (
    <>
      <Helmet>
        <title>House Cleaning in Boyle Street, Edmonton | Duty Cleaners</title>
        <meta name="description" content="Professional house cleaning in Boyle Street, Edmonton. Trusted local cleaners serving Boyle Street homes with reliable, customer-rated cleaning service." />
  ...
  description: "Professional house cleaning services in Boyle Street, Edmonton.",
  geo: { latitude: "53.547", longitude: "-113.481" },
}))}
        </script>
        <link rel="canonical" href="https://dutycleaners.ca/locations/boyle-street-edmonton/" />
        <meta property="og:title" content="House Cleaning in Boyle Street, Edmonton | Duty Cleaners" />
        <meta property="og:description" content="Professional house cleaning in Boyle Street, Edmonton. Trusted local cleaners serving Boyle Street homes with reliable, customer-rated cleaning service." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://dutycleaners.ca/locations/boyle-street-edmonton/" />
        <meta property="og:image" content="https://dutycleaners.ca/og-image.jpg" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="House Cleaning in Boyle Street, Edmonton | Duty Cleaners" />
        <meta name="twitter:description" content="Professional house cleaning in Boyle Street, Edmonton. Trusted local cleaners serving Boyle Street homes with reliable, customer-rated cleaning service." />
      </Helmet>
            ...
            <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12">
              <div className="flex-1 text-center lg:text-left">
                <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-5 py-2 mb-6">
                  ...
                  <span className="text-white/90 text-sm font-medium">Serving Boyle Street, Edmonton</span>
                </div>
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-2 mb-6">Residential Cleaning in Boyle Street</h2>
            ...
            <AnimatedSection>
              <div className="text-center mb-14">
                ...
                <p className="text-white/90 max-w-2xl mx-auto text-lg">
                  Trusted by Boyle Street families for reliable, thorough cleaning.
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection>
            ...
            <AnimatedSection>
              ...
              <div className="max-w-4xl mx-auto rounded-2xl overflow-hidden shadow-lg border border-border">
                <Suspense fallback={<div className="w-full h-[400px] bg-muted animate-pulse rounded-2xl" />}>
                  <LocationMap center={[53.547, -113.481]} label="Boyle Street, Edmonton" />
                </Suspense>
              </div>
            </AnimatedSection>
          </div>
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            <AnimatedSection>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Ready for a Spotless Home in Boyle Street?
              </h2>
