...
const services = [
  { icon: Home, title: "Standard Cleaning", description: "A thorough one-time cleaning for homes in Mount Pleasant.", to: "/calgary/regular-cleaning/", linkText: "Standard cleaning in Mount Pleasant" },
...
const whyUsItems = [
  ...
  { icon: Clock, title: "Flexible Scheduling", description: "Same-day and next-day availability in Mount Pleasant. We work around your busy life." },
          ...
          <div className="container mx-auto px-4">
            ...
            <AnimatedSection>
              ...
              <p className="mt-10 text-center text-muted-foreground">
                {"Mount Pleasant is one of the Calgary neighbourhoods we clean — see "}
                <Link
