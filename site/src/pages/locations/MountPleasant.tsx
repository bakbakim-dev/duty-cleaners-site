...
import cleanHomeImg from "@/assets/gallery/neighborhoods/mount-pleasant.jpg";
...
const services = [
  { icon: Home, title: "Standard Cleaning", description: "A thorough one-time cleaning for homes in Mount Pleasant." },
...
const landmarks = [
  {
    "title": "Mount Pleasant Outdoor Pool",
    "url": "https://www.google.com/maps/place/Mount+Pleasant+Outdoor+Pool,+Calgary,+AB/",
    "description": "Iconic summer outdoor pool"
  },
  {
    "title": "Confederation Park",
    "url": "https://www.google.com/maps/place/Confederation+Park,+Calgary,+AB/",
    "description": "Park, golf, and pathway system"
  },
  {
    "title": "SAIT Polytechnic",
    "url": "https://www.google.com/maps/place/SAIT,+Calgary,+AB/",
    "description": "Calgary's polytechnic institute"
  },
  {
    "title": "Mount Pleasant Arena",
    "url": "https://www.google.com/maps/place/Mount+Pleasant+Arena,+Calgary,+AB/",
    "description": "Year-round community ice rink"
  }
];
...
const structuredData = buildLocationSchema({
  name: "Duty Cleaners - Mount Pleasant Calgary",
  city: "calgary",
  url: "https://dutycleaners.ca/locations/mount-pleasant-calgary",
  priceRange: "$155-$519",
  geo: { latitude: "51.0760", longitude: "-114.0800" },
});
...
export default function MountPleasant() {
  ...
  return (
    <>
      <Helmet>
        <title>House Cleaning Services in Mount Pleasant, Calgary | Duty Cleaners</title>
        <meta name="description" content="Professional house cleaning in Mount Pleasant, Calgary. Same-day service available. 100% satisfaction guaranteed. Pay after your clean. Get a free quote today!" />
        <meta property="og:title" content="House Cleaning Services Mount Pleasant Calgary | Duty Cleaners" />
        <meta property="og:description" content="Professional house cleaning in Mount Pleasant, Calgary. Same-day service available. 100% satisfaction guaranteed." />
      ...
      <div className="min-h-screen">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-5 py-2 mb-6">
                ...
                <span className="text-white/90 text-sm font-medium">Serving Mount Pleasant, N Calgary</span>
              </div>
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-2 mb-6">Cleaning Services Trusted Across Mount Pleasant</h2>
                <div className="text-muted-foreground space-y-4 text-lg leading-relaxed">
                  <p>Mount Pleasant is a beloved inner-city community known for its character bungalows, mature trees, and the Mount Pleasant Outdoor Pool — a summer institution. With easy access to SAIT, 16th Ave, and Confederation Park, it appeals to families, professionals, and students.</p>
                  <p>We work in everything from renovated 1920s bungalows to luxury infills here. Our cleaners are reference-checked, customer-rated, and trained to a consistent quality standard — every clean, every time.</p>
                </div>
              </div>
            </AnimatedSection>
          </div>
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="text-center mb-14 max-w-3xl mx-auto">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-2 mb-4">Around Mount Pleasant</h2>
                <p className="text-muted-foreground text-lg">
                  We know the area inside and out — here are a few of the places that make Mount Pleasant feel like home.
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection>
            ...
            <AnimatedSection>
              <div className="max-w-5xl mx-auto">
                ...
                <div className="rounded-2xl overflow-hidden shadow-xl border border-border">
                  <iframe
                    src="https://www.google.com/maps?q=Mount+Pleasant,+Calgary,+AB&output=embed"
                    width="100%"
                    height="450"
                    style={{ border: 0 }}
                    allowFullScreen
                    ...
                    title="Mount Pleasant Calgary Service Area Map"
                  />
                </div>
              </div>
            </AnimatedSection>
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="text-center mb-10">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto">
                  We proudly serve families and homeowners across Mount Pleasant and surrounding N Calgary communities.
                </p>
              </div>
        ...
        <section className="py-20 bg-brand-navy relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            <AnimatedSection>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Ready for a Spotless Home in Mount Pleasant?</h2>
