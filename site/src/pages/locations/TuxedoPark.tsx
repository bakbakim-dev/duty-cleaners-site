...
const services = [
  { icon: Home, title: "Standard Cleaning", description: "A thorough one-time cleaning for busy Tuxedo Park schedules." },
  { icon: Sparkles, title: "Deep Cleaning", description: "Detailed deep cleans for character homes and modern infills alike." },
  { icon: Truck, title: "Move In/Out Cleaning", description: "Move cleans timed precisely to your possession date." },
  { icon: SprayCan, title: "Post-Construction Cleanup", description: "Drywall and renovation dust removal after infill projects." },
  { icon: Bath, title: "Bathroom Sanitization", description: "Bathroom deep cleans with thorough disinfection." },
  { icon: Building2, title: "Commercial Cleaning", description: "Commercial cleaning for businesses along 16th Ave and Centre Street." },
];
...
const whyUsItems = [
  ...
  { icon: Clock, title: "Flexible Scheduling", description: "Same-day and next-day availability in Tuxedo Park. We work around your busy life." },
...
const landmarks = [
  {
    "title": "16th Avenue Restaurants",
    "url": "https://www.google.com/maps/place/16+Ave+NW,+Calgary,+AB/",
    "description": "Caf\u00e9s, brunch spots, and dining"
  },
  {
    "title": "Confederation Park",
    "url": "https://www.google.com/maps/place/Confederation+Park,+Calgary,+AB/",
    "description": "Sprawling green space and ponds"
  },
  {
    "title": "SAIT Polytechnic",
    "url": "https://www.google.com/maps/place/SAIT,+Calgary,+AB/",
    "description": "Leading post-secondary nearby"
  },
  {
    "title": "Centre Street N LRT (Future)",
    "url": "https://www.google.com/maps/place/Centre+Street+N,+Calgary,+AB/",
    "description": "Future Green Line transit corridor"
  }
];
...
const faqs = [
  {
    ...
    answer: `We work to a checklist, not a clock. Your Tuxedo Park team stays until every task in your service scope is complete, and your flat rate does not change based on how long it takes.`
  },
  {
  ...
  },
  {
    ...
    answer: `Yes — recurring Tuxedo Park customers save:\n\n• Every week: 20% off\n• Every two weeks: 15% off\n• Every four weeks: 10% off`
  },
  {
    question: "What's included in a deep cleaning?",
    answer: `A Tuxedo Park deep clean adds to the standard package:\n\n• Wall outlet covers wiped\n• Cobweb removal\n• Ceiling fans dusted and cleaned\n• Light switches fully cleaned\n• All reachable vents cleaned\n• And more!`
  },
  {
    question: "What is your 100% satisfaction guarantee policy?",
    answer: "If you're not 100% satisfied, call us within 24 hours and we'll come back to your Tuxedo Park home and make it right — at no extra cost!"
  }
];
...
export default function TuxedoPark() {
  useEffect(() => {
    document.title = "House Cleaning Services Tuxedo Park | Duty Cleaners";
    window.scrollTo(0, 0);
  }, []);
  ...
  return (
    <>
      <Helmet>
        <title>House Cleaning in Tuxedo Park, Calgary | Duty Cleaners</title>
        <meta name="description" content="Professional house cleaning in Tuxedo Park, Calgary. Same-day service subject to availability. 100% satisfaction guaranteed. Pay after your clean." />
        <meta property="og:title" content="House Cleaning Services Tuxedo Park Calgary | Duty Cleaners" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="House Cleaning Services Tuxedo Park Calgary | Duty Cleaners" />
        <meta name="twitter:description" content="Professional house cleaning in Tuxedo Park, Calgary. Same-day service subject to availability. 100% satisfaction guaranteed." />
        <meta property="og:description" content="Professional house cleaning in Tuxedo Park, Calgary. Same-day service subject to availability. 100% satisfaction guaranteed." />
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-5 py-2 mb-6">
                ...
                <span className="text-white/90 text-sm font-medium">Serving Tuxedo Park, N Calgary</span>
              </div>
            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <div className="text-muted-foreground space-y-4 text-lg leading-relaxed">
                  ...
                  <p>We understand the unique needs of mixed-vintage homes — the patience an old hardwood floor needs, the systems-thinking an open-concept infill rewards. Our team brings care, consistency, and professional products to every visit.</p>
                </div>
              </div>
            </AnimatedSection>
          </div>
            ...
            <AnimatedSection>
              <div className="text-center mb-14">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
                  From routine upkeep to move-outs, Tuxedo Park homes get every service they need.
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection>
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="text-center mb-14 max-w-3xl mx-auto">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-2 mb-4">Around Tuxedo Park</h2>
                <p className="text-muted-foreground text-lg">
                  We know the area inside and out — here are a few of the places that make Tuxedo Park feel like home.
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection>
            ...
            <AnimatedSection>
              <div className="max-w-5xl mx-auto">
                ...
                <div className="rounded-2xl overflow-hidden shadow-xl border border-border">
                  <iframe
                    src="https://www.google.com/maps?q=Tuxedo+Park,+Calgary,+AB&output=embed"
                    width="100%"
                    height="450"
                    style={{ border: 0 }}
                    allowFullScreen
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="text-center mb-10">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto">
                  We proudly serve families and homeowners across Tuxedo Park and surrounding N Calgary communities.
                </p>
              </div>
      ...
      <LocationPricing />
            ...
            <AnimatedSection>
              <div className="text-center mb-14">
                ...
                <p className="text-white/90 max-w-2xl mx-auto text-lg">
                  Trusted by Tuxedo Park families for reliable, thorough cleaning.
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection>
        ...
        <section className="py-20 bg-brand-navy relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            <AnimatedSection>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Ready for a Spotless Home in Tuxedo Park?</h2>
