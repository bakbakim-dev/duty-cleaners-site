...
import heroImg from "@/assets/gallery/glengarry-cleaner-home.webp";
...
const services = [
  { icon: Home, title: "Standard Cleaning", description: "A one-time clean of every room, priced flat by home size.", to: "/edmonton/regular-cleaning/", linkText: "Standard cleaning in Glengarry" },
  { icon: Sparkles, title: "Deep Cleaning", description: "The standard checklist plus the deep-clean package: cobwebs, ceiling fans, light switches, outlet covers and vent covers.", to: "/edmonton/deep-cleaning/", linkText: "Deep cleaning in Glengarry" },
  { icon: Truck, title: "Move In/Out Cleaning", description: "Inside the oven, fridge and microwave, and inside every cabinet, drawer and closet.", to: "/move-out-cleaning-edmonton/", linkText: "Move-out cleaning in Glengarry" },
  { icon: SprayCan, title: "Post-Construction Cleanup", description: "Dust and light debris are cleared after renovations or new builds in Glengarry.", to: "/post-construction-cleaning/", linkText: "Post-construction cleaning in Glengarry" },
  { icon: PaintRoller, title: "Wall Washing", description: "Scuffs, handprints and cooking film off painted walls, without stripping the finish.", to: "/wall-washing-wall-cleaning/", linkText: "Wall washing in Glengarry" },
  ...
  { icon: CalendarCheck, title: "Recurring Cleaning", description: `The standard checklist on a schedule, from ${RECURRING_FROM} a visit for a one-bedroom, one-bathroom apartment or condo, before GST and any pet or home-type charge. From the second clean on, weekly takes ${OFF_WEEKLY} off, every two weeks ${OFF_BIWEEKLY} and every four weeks ${OFF_FOUR_WEEKLY}.`, to: "/edmonton/recurring-cleaning/", linkText: "Recurring cleaning in Glengarry" },
];
...
export default function Glengarry() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  const faqs = [
    ...
    {
      question: "What cleaning services does Duty Cleaners offer in Glengarry?",
      answer: `Around Glengarry we offer the full range:\n\n• Standard & Deep Cleaning Packages\n• Move-In & Move-Out Cleaning\n• Post-Construction Cleaning\n• Wall Washing and Wall Cleaning`
    },
    {
    ...
    },
    {
      ...
      answer: `In Glengarry, a deep clean adds to the standard package:\n\n• Wall outlet covers wiped\n• Cobweb removal\n• Ceiling fans dusted and cleaned\n• Light switches fully cleaned\n• Vent covers wiped`
    },
    {
      question: "What happens if something is missed?",
      answer: "Tell us within 24 hours and the team comes back to your Glengarry home to re-clean what was missed, at no charge. Photos help but are not required."
    }
  ];
  const faqJsonLd = {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Basement suites are common in Glengarry's 1960s Edmonton bungalows, and a suite doubles the kitchens and bathrooms a clean has to cover." />
  ...
  geo: { latitude: "53.585", longitude: "-113.498" },
        ...
        <meta property="og:description" content="Basement suites are common in Glengarry's 1960s Edmonton bungalows, and a suite doubles the kitchens and bathrooms a clean has to cover." />
        ...
        <meta name="twitter:description" content="Basement suites are common in Glengarry's 1960s Edmonton bungalows, and a suite doubles the kitchens and bathrooms a clean has to cover." />
      </Helmet>
            ...
            <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12">
              <div className="flex-1 text-center lg:text-left">
                <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-5 py-2 mb-6">
                  ...
                  <span className="text-white/90 text-sm font-medium">Serving Glengarry, Edmonton</span>
                </div>
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
                  Professional House Cleaning in Glengarry
                </h1>
                <p className="text-lg md:text-xl text-white/80 mb-10 max-w-3xl leading-relaxed">
                  Many of Glengarry's 1960s bungalows still have their original kitchens, and homes within a block or two of 97 Street take in more winter sand at the door. The Edmonton branch prices each clean flat by home size.
                </p>
              ...
              <div className="lg:w-[500px] flex-shrink-0">
                <img
                  src={heroImg}
                  alt="Cleaner dusting window blinds"
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="text-center mb-14">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-2 mb-4">
                  Cleaning Services for Glengarry Homes
                </h2>
                <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
                  The Edmonton branch offers six services for Glengarry homes, each priced before 5% GST: flat by home size, or by square footage for post-construction. A bungalow adds a home-type surcharge that shows on the quote before you book.
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection>
            ...
            <AnimatedSection>
              ...
              <p className="mt-10 text-center text-muted-foreground">
                {"Glengarry is one of the Edmonton neighbourhoods we clean — see "}
            ...
            <AnimatedSection>
              <div className="text-center mb-14">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-white mt-2 mb-4">
                  Why Glengarry Residents Choose Duty Cleaners
                </h2>
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="max-w-4xl mx-auto text-center mb-10">
                ...
                <h2 className="text-3xl font-bold text-foreground mt-2 mb-4">Serving the Glengarry Area</h2>
                <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                  There is no trip fee for a Glengarry clean: the neighbourhood is inside Edmonton city limits.
                </p>
              </div>
            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                <div className="text-center mb-10">
                  ...
                  <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                    Delwood, Balwin and Evansdale are also on the Edmonton branch's list of 80 neighbourhoods.
                  </p>
                </div>
                <CoverageChips areas={["Delwood", "Balwin", "Evansdale"]} variant="compact" />
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            <AnimatedSection>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Ready to Book a Clean in Glengarry?
              </h2>
