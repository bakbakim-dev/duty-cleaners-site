...
import heroImg from "@/assets/gallery/glengarry-cleaner-home.jpg";
...
export default function Glengarry() {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional house cleaning in Glengarry, Edmonton. Trusted local cleaners serving north Edmonton families. Customer-rated cleaners and five-star rated service." />
  ...
  description: "Professional house cleaning services in Glengarry, Edmonton.",
        ...
        <meta property="og:description" content="Professional house cleaning in Glengarry, Edmonton. Trusted local cleaners serving north Edmonton families. Customer-rated cleaners and five-star rated service." />
        ...
        <meta name="twitter:description" content="Professional house cleaning in Glengarry, Edmonton. Trusted local cleaners serving north Edmonton families. Customer-rated cleaners and five-star rated service." />
      </Helmet>
