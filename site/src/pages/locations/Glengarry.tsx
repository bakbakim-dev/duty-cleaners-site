...
const services = [
  { icon: Home, title: "Standard Cleaning", description: "A thorough one-time cleaning to refresh your Glengarry home spotless and fresh year-round." },
  { icon: Sparkles, title: "Deep Cleaning", description: "Thorough top-to-bottom cleaning of your Glengarry home — every corner, baseboard, and hidden surface." },
  { icon: Truck, title: "Move In/Out Cleaning", description: "Detailed cleaning for a smooth Glengarry move — leave or arrive to a pristine home." },
  { icon: SprayCan, title: "Post-Construction Cleanup", description: "Expert dust and debris removal after renovations or new builds around Glengarry." },
...
const whyUsItems = [
  ...
  { icon: Clock, title: "Flexible Scheduling", description: "Same-day and next-day availability in Glengarry. We work around your busy life." },
...
export default function Glengarry() {
  ...
  const faqs = [
    {
      ...
      answer: `We work to a checklist, not a clock. Your Glengarry team stays until every task in your service scope is complete, and your flat rate does not change based on how long it takes.`
    },
    {
    ...
    },
    {
      ...
      answer: `Yes — recurring Glengarry customers save:\n\n• Every week: 20% off\n• Every two weeks: 15% off\n• Every four weeks: 10% off`
    },
    {
      question: "What's included in a deep cleaning?",
      answer: `A Glengarry deep clean adds to the standard package:\n\n• Wall outlet covers wiped\n• Cobweb removal\n• Ceiling fans dusted and cleaned\n• Light switches fully cleaned\n• All reachable vents cleaned\n• And more!`
    },
    {
      question: "What is your 100% satisfaction guarantee policy?",
      answer: "If you're not 100% satisfied, call us within 24 hours and we'll come back to your Glengarry home and make it right — at no extra cost!"
    }
  ];
  const faqJsonLd = {
  ...
  return (
    <>
      <Helmet>
        <title>House Cleaning in Glengarry, Edmonton | Duty Cleaners</title>
  ...
  description: "Professional house cleaning services in Glengarry, Edmonton.",
  geo: { latitude: "53.585", longitude: "-113.498" },
}))}
        </script>
        <link rel="canonical" href="https://dutycleaners.ca/locations/glengarry-edmonton/" />
        <meta property="og:title" content="House Cleaning in Glengarry, Edmonton | Duty Cleaners" />
        ...
        <meta name="twitter:title" content="House Cleaning in Glengarry, Edmonton | Duty Cleaners" />
            ...
            <AnimatedSection>
              <div className="text-center mb-14">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
                  From routine upkeep to move-outs, Glengarry homes get every service they need.
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection>
