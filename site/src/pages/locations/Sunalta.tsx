...
import cleanHomeImg from "@/assets/gallery/neighborhoods/sunalta.jpg";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional house cleaning in Sunalta, Calgary. Same-day service available. 100% satisfaction guaranteed. Pay after your clean. Get a free quote today!" />
        <meta property="og:title" content="House Cleaning Services Sunalta Calgary | Duty Cleaners" />
        <meta property="og:description" content="Professional house cleaning in Sunalta, Calgary. Same-day service available. 100% satisfaction guaranteed." />
