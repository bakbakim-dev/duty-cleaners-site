...
import heroImg from "@/assets/gallery/riverdale-cleaner-home.jpg";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional house cleaning in Riverdale, Edmonton. Trusted local cleaners serving central Edmonton families. Customer-rated cleaners and five-star rated service." />
