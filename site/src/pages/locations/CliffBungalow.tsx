...
import cleanHomeImg from "@/assets/gallery/neighborhoods/cliff-bungalow.jpg";
...
export default function CliffBungalow() {
  ...
  return (
    <>
      <Helmet>
        <title>House Cleaning Services in Cliff Bungalow, Calgary | Duty Cleaners</title>
            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <div className="text-muted-foreground space-y-4 text-lg leading-relaxed">
                  ...
                  <p>Whether you live in a renovated bungalow, a heritage walk-up, or a sleek new infill, our team adapts to your home's quirks — using non-toxic products that are gentle on original woodwork and safe for every member of the family.</p>
                </div>
              </div>
            </AnimatedSection>
          </div>
