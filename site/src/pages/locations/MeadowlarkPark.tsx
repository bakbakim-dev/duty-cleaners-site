...
import cleanHomeImg from "@/assets/gallery/neighborhoods/meadowlark-park.jpg";
...
export default function MeadowlarkPark() {
  ...
  return (
    <>
      <Helmet>
        <title>House Cleaning Services in Meadowlark Park, Calgary | Duty Cleaners</title>
        <meta name="description" content="Professional house cleaning in Meadowlark Park, Calgary. Same-day service available. 100% satisfaction guaranteed. Pay after your clean. Get a free quote today!" />
        <meta property="og:title" content="House Cleaning Services Meadowlark Park Calgary | Duty Cleaners" />
        <meta property="og:description" content="Professional house cleaning in Meadowlark Park, Calgary. Same-day service available. 100% satisfaction guaranteed." />
            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <div className="text-muted-foreground space-y-4 text-lg leading-relaxed">
                  ...
                  <p>From original bungalows to thoughtful renovations, our team adapts to your home's character — using non-toxic products that protect your finishes and keep indoor air fresh for kids, pets, and guests.</p>
                </div>
              </div>
            </AnimatedSection>
          </div>
