...
import heroImg from "@/assets/gallery/glenwood-cleaner-home.webp";
...
const services = [
  { icon: Home, title: "Standard Cleaning", description: "A thorough one-time cleaning for a spotless, fresh reset in one visit.", to: "/edmonton/regular-cleaning/", linkText: "Standard cleaning in Glenwood" },
  { icon: Sparkles, title: "Deep Cleaning", description: "Every corner, baseboard, and hidden surface, cleaned top to bottom.", to: "/edmonton/deep-cleaning/", linkText: "Deep cleaning in Glenwood" },
  { icon: Truck, title: "Move In/Out Cleaning", description: "Inspection-grade detail for moving out or settling in.", to: "/move-out-cleaning-edmonton/", linkText: "Move-out cleaning in Glenwood" },
  { icon: SprayCan, title: "Post-Construction Cleanup", description: "Post-renovation dust and debris, professionally removed.", to: "/post-construction-cleaning/", linkText: "Post-construction cleaning in Glenwood" },
  { icon: PaintRoller, title: "Wall Washing", description: "Scuffs, handprints and cooking film off painted walls, without stripping the finish.", to: "/wall-washing-wall-cleaning/", linkText: "Wall washing in Glenwood" },
  ...
  { icon: CalendarCheck, title: "Recurring Cleaning", description: `The standard checklist on a schedule, from ${RECURRING_FROM} a visit. From the second clean on, weekly takes ${OFF_WEEKLY} off, every two weeks ${OFF_BIWEEKLY} and every four weeks ${OFF_FOUR_WEEKLY}.`, to: "/edmonton/recurring-cleaning/", linkText: "Recurring cleaning in Glenwood" },
];
...
const whyUsItems = [
  ...
  { icon: Clock, title: "Flexible Scheduling", description: "Same-day and next-day availability in Glenwood. We work around your busy life." },
...
export default function Glenwood() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  const faqs = [
    ...
    },
    {
      ...
      answer: `Yes — customers in Glenwood on a recurring schedule save:\n\n• Every week: 20% off\n• Every two weeks: 15% off\n• Every four weeks: 10% off`
    },
    {
      question: "What's included in a deep cleaning?",
      answer: `In Glenwood, a deep clean adds to the standard package:\n\n• Wall outlet covers wiped\n• Cobweb removal\n• Ceiling fans dusted and cleaned\n• Light switches fully cleaned\n• All reachable vents cleaned`
    },
    {
  ...
  return (
    <>
      <Helmet>
        <title>House Cleaning in Glenwood, Edmonton | Duty Cleaners</title>
        <meta name="description" content="House cleaning in Glenwood, Edmonton. Trusted local cleaners serving west Edmonton families. Customer-rated cleaners, rated 4.9 on Google." />
        <script type="application/ld+json">
          {JSON.stringify(buildLocationSchema({
  name: "Duty Cleaners – Glenwood, Edmonton",
  city: "edmonton",
  url: "https://dutycleaners.ca/locations/glenwood-edmonton",
  areaServed: "Glenwood, Edmonton, AB",
  description: "Professional house cleaning in Glenwood, Edmonton. Trusted local cleaners serving west Edmonton families. Customer-rated cleaners, rated 4.9 on Google.",
  geo: { latitude: "53.53", longitude: "-113.621" },
        ...
        <meta property="og:description" content="House cleaning in Glenwood, Edmonton. Trusted local cleaners serving west Edmonton families. Customer-rated cleaners, rated 4.9 on Google." />
        ...
        <meta name="twitter:description" content="House cleaning in Glenwood, Edmonton. Trusted local cleaners serving west Edmonton families. Customer-rated cleaners, rated 4.9 on Google." />
      </Helmet>
            ...
            <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12">
              <div className="flex-1 text-center lg:text-left">
                <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-5 py-2 mb-6">
                  ...
                  <span className="text-white/90 text-sm font-medium">Serving Glenwood, Edmonton</span>
                </div>
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
                  Professional House Cleaning in Glenwood
                </h1>
                <p className="text-lg md:text-xl text-white/80 mb-10 max-w-3xl leading-relaxed">
                  Your reliable, local cleaning team serving the Glenwood community. From classic 1950s bungalows on quiet crescents to renovated infills near Stony Plain Road — enjoy dependable cleaning built on trust and genuine care.
                </p>
              ...
              <div className="lg:w-[500px] flex-shrink-0">
                <img
                  src={heroImg}
                  alt="Professional cleaner wiping a living room window in a Glenwood, Edmonton home"
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-2 mb-6">Residential Cleaning in Glenwood</h2>
                <div className="space-y-4 text-muted-foreground leading-relaxed text-lg">
                  <p>
                    Glenwood is a leafy, family-friendly community in west Edmonton with mature streets, mid-century bungalows and easy access to Stony Plain Road. The people who live here take pride in their homes, and at Duty Cleaners, we're proud to be part of the rhythm of daily life in Glenwood.
                  </p>
                  <p>
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="text-center mb-14">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-2 mb-4">
                  Cleaning Services for Glenwood Homes
                </h2>
            ...
            <AnimatedSection>
              ...
              <p className="mt-10 text-center text-muted-foreground">
                {"Glenwood is one of the Edmonton neighbourhoods we clean — see "}
            ...
            <AnimatedSection>
              <div className="text-center mb-14">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-white mt-2 mb-4">
                  Why Glenwood Residents Choose Duty Cleaners
                </h2>
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="max-w-4xl mx-auto text-center mb-10">
                ...
                <h2 className="text-3xl font-bold text-foreground mt-2 mb-4">Serving the Glenwood Area</h2>
                <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                  Located in west Edmonton, we're always just around the corner.
                </p>
              </div>
            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                <div className="text-center mb-10">
                  ...
                  <h2 className="text-3xl font-bold text-foreground mt-2 mb-4">We Know Glenwood</h2>
                  <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                    We're in and around the neighbourhood daily, so we know the area well.
                  </p>
                </div>
                <CoverageChips areas={["Glenwood Park", "Stony Plain Road", "Glenwood Elementary", "156 Street", "Meadowlark Health Centre", "100 Avenue", "West Edmonton Mall", "Mayfield"]} variant="compact" />
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            <AnimatedSection>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Ready for a Spotless Home in Glenwood?
              </h2>
