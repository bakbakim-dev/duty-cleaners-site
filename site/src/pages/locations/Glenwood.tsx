  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional house cleaning in Glenwood, Edmonton. Trusted local cleaners serving west Edmonton families. Customer-rated cleaners and five-star rated service." />
            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed text-lg">
                  ...
                  <p>
                    Whether your home is                    <a href="https://www.google.com/maps/place/Glenwood+Park,+Edmonton,+AB/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Glenwood Park</a>,
