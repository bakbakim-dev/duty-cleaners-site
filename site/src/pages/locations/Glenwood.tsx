...
const services = [
  ...
  { icon: Sparkles, title: "Deep Cleaning", description: "The standard checklist plus the deep-clean package: cobwebs, ceiling fans, light switches, outlet covers and vent covers.", to: "/edmonton/deep-cleaning/", linkText: "Deep cleaning in Glenwood" },
  ...
  { icon: SprayCan, title: "Post-Construction Cleanup", description: "Dust and light debris are cleared after a renovation or a new build in Glenwood.", to: "/post-construction-cleaning/", linkText: "Post-construction cleaning in Glenwood" },
  ...
  { icon: CalendarCheck, title: "Recurring Cleaning", description: `The standard checklist on a schedule, from ${RECURRING_FROM} a visit for a one-bedroom, one-bathroom apartment or condo, before GST and any pet or home-type charge. From the second clean on, weekly takes ${OFF_WEEKLY} off, every two weeks ${OFF_BIWEEKLY} and every four weeks ${OFF_FOUR_WEEKLY}.`, to: "/edmonton/recurring-cleaning/", linkText: "Recurring cleaning in Glenwood" },
];
...
export default function Glenwood() {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Glenwood's 1950s Edmonton bungalows pack trim, doors and built-ins into few rooms, and a garden suite adds a second small kitchen to clean." />
  ...
  geo: { latitude: "53.53", longitude: "-113.621" },
        ...
        <meta property="og:description" content="Glenwood's 1950s Edmonton bungalows pack trim, doors and built-ins into few rooms, and a garden suite adds a second small kitchen to clean." />
        ...
        <meta name="twitter:description" content="Glenwood's 1950s Edmonton bungalows pack trim, doors and built-ins into few rooms, and a garden suite adds a second small kitchen to clean." />
      </Helmet>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12">
              ...
              <div className="lg:w-[500px] flex-shrink-0">
                <img
                  src={heroImg}
                  alt="Cleaner wiping a living room window"
            ...
            <AnimatedSection>
              <div className="text-center mb-14">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
                  The Edmonton branch offers six services for Glenwood homes, one visit at a time or on a recurring schedule, each priced before 5% GST: flat by home size, or by square footage for post-construction.
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection>
            ...
            <AnimatedSection>
              <div className="text-center mb-14">
                ...
                <p className="text-white/90 max-w-2xl mx-auto text-lg">
                  Glenwood customers rate every visit, and those ratings decide which reference-checked cleaners we keep sending.
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection>
            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto text-center mb-10">
                ...
                <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                  Stony Plain Road marks Glenwood's north edge and 156 Street its east edge, and the neighbourhood is inside Edmonton city limits, so no trip fee applies.
                </p>
              </div>
            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                <div className="text-center mb-10">
                  ...
                  <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                    The Edmonton branch also cleans Mayfield, one of 80 neighbourhoods on its list inside the city.
                  </p>
                </div>
                <CoverageChips areas={["Mayfield"]} variant="compact" />
