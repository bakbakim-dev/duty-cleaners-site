  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Book house cleaning in Crossfield in about 60 seconds. Reference-checked cleaners and a 24-hour make-it-right guarantee." />
        ...
        <meta name="twitter:description" content="Book house cleaning in Crossfield in about 60 seconds. Reference-checked cleaners and a 24-hour make-it-right guarantee." />
        <meta property="og:description" content="Book house cleaning in Crossfield in about 60 seconds. Reference-checked cleaners and a 24-hour make-it-right guarantee." />
