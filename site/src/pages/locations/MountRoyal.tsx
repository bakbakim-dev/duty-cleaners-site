...
const whyUsItems = [
  ...
  { icon: Leaf, title: "Premium Products", description: "High-quality, non-toxic products safe for delicate surfaces and antique fixtures." },
              ...
              <div className="max-w-4xl mx-auto">
                ...
                <div className="rounded-2xl overflow-hidden shadow-xl">
                  <iframe
                    ...
                    referrerPolicy="no-referrer-when-downgrade" title="Mount Royal Service Area Map"
                  />
                </div>
              </div>
            </AnimatedSection>
