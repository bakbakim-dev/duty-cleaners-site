...
import heroImg from "@/assets/gallery/hollick-kenyon-cleaner-home.jpg";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional house cleaning in Hollick-Kenyon, Edmonton. Trusted local cleaners serving northeast Edmonton families. Customer-rated cleaners and five-star rated service." />
