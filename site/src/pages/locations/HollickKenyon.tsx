...
const services = [
  { icon: Home, title: "Standard Cleaning", description: "A thorough one-time cleaning to bring the whole home back to baseline.", to: "/edmonton/regular-cleaning/", linkText: "Standard cleaning in Hollick-Kenyon" },
  { icon: Sparkles, title: "Deep Cleaning", description: "Every corner, baseboard, and hidden surface, cleaned top to bottom.", to: "/edmonton/deep-cleaning/", linkText: "Deep cleaning in Hollick-Kenyon" },
  { icon: Truck, title: "Move In/Out Cleaning", description: "Inspection-grade detail for moving out or settling in.", to: "/move-out-cleaning-edmonton/", linkText: "Move-out cleaning in Hollick-Kenyon" },
            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed text-lg">
                  <p>
                    Hollick-Kenyon is a modern northeast Edmonton family community with newer two-storey homes, schools and trail-connected parks. The people who live here take pride in their homes, and at Duty Cleaners, we're proud to be part of the rhythm of daily life in Hollick-Kenyon.
                  </p>
                  <p>
                    Whether your home is near{" "}
                    <a href="https://www.google.com/maps/search/Mary+Hanley+School+Edmonton/" target="_blank" rel="noopener noreferrer" className="text-primary underline underline-offset-2">Mary Hanley School</a>,
                    ...
                    minutes from <a href="https://www.google.com/maps/place/50+St+NW,+Edmonton,+AB/" target="_blank" rel="noopener noreferrer" className="text-primary underline underline-offset-2">50 Street</a>,
                    or close to <a href="https://www.google.com/maps/place/167+Ave+NW,+Edmonton,+AB/" target="_blank" rel="noopener noreferrer" className="text-primary underline underline-offset-2">167 Avenue</a>,
          ...
          <div className="container mx-auto px-4">
            ...
            <AnimatedSection>
              ...
              <p className="mt-10 text-center text-muted-foreground">
                {"Hollick-Kenyon is one of the Edmonton neighbourhoods we clean — see "}
