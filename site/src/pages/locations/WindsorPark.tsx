...
import cleanHomeImg from "@/assets/gallery/neighborhoods/windsor-park.jpg";
...
export default function WindsorPark() {
  ...
  return (
    <>
      <Helmet>
        <title>House Cleaning Services in Windsor Park, Calgary | Duty Cleaners</title>
            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <div className="text-muted-foreground space-y-4 text-lg leading-relaxed">
                  ...
                  <p>Whether it's weekly upkeep, a pre-dinner-party polish, or a full deep clean, our team brings consistency, attention to detail, and non-toxic products you'll feel good about using around your family.</p>
                </div>
              </div>
            </AnimatedSection>
          </div>
