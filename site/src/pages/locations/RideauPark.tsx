...
import cleanHomeImg from "@/assets/gallery/neighborhoods/rideau-park.jpg";
...
export default function RideauPark() {
  ...
  return (
    <>
      <Helmet>
        <title>House Cleaning Services in Rideau Park, Calgary | Duty Cleaners</title>
            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <div className="text-muted-foreground space-y-4 text-lg leading-relaxed">
                  ...
                  <p>From split-levels to luxury renovations, we tailor each visit to your home and routine, using safe, non-toxic products that protect fine finishes, hardwood, and the people you share your space with.</p>
                </div>
              </div>
            </AnimatedSection>
          </div>
