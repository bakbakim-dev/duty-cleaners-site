...
const services = [
  { icon: Home, title: "Standard Cleaning", description: "A thorough one-time cleaning for a spotless, fresh reset in one visit.", to: "/calgary/regular-cleaning/", linkText: "Standard cleaning in Crescent Heights" },
  { icon: Sparkles, title: "Deep Cleaning", description: "A full top-to-bottom reset — corners, baseboards, and the surfaces regular visits skip.", to: "/calgary/deep-cleaning/", linkText: "Deep cleaning in Crescent Heights" },
  { icon: Truck, title: "Move In/Out Cleaning", description: "Move-day cleaning done to the standard landlords check for.", to: "/move-out-cleaning-calgary/", linkText: "Move-out cleaning in Crescent Heights" },
            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <div className="text-muted-foreground space-y-4 text-lg leading-relaxed">
                  <p>
                    Crescent Heights sits high on the bluff overlooking downtown — a leafy, established community famous for its skyline viewpoints, character bungalows, and walkable Centre Street energy. A standing visit keeps the house at baseline through the busiest stretches: calm, fresh, and guest-ready.
                  </p>
                  <p>
