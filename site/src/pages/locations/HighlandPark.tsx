...
const services = [
  { icon: Home, title: "Standard Cleaning", description: "A one-time thorough cleaning for Highland Park homes consistently fresh." },
  { icon: Sparkles, title: "Deep Cleaning", description: "Top-to-bottom deep cleans ideal for spring or post-holiday resets." },
  { icon: Truck, title: "Move In/Out Cleaning", description: "Move-in and move-out cleans for buyers, sellers, and renters." },
  { icon: SprayCan, title: "Post-Construction Cleanup", description: "Post-reno dust removal for the area's many infill projects." },
...
const whyUsItems = [
  ...
  { icon: Clock, title: "Flexible Scheduling", description: "Same-day and next-day availability in Highland Park. We work around your busy life." },
...
const landmarks = [
  {
    ...
    "description": "Beloved park with golf, trails, and ponds"
  },
  {
    "title": "Centre Street N Shops",
    "url": "https://www.google.com/maps/place/Centre+Street+N,+Calgary,+AB/",
    "description": "Diverse local shops and restaurants"
  },
  {
    "title": "Highland Park Community Hall",
    "url": "https://www.google.com/maps/place/Highland+Park+Community+Association,+Calgary,+AB/",
    "description": "Local events and recreation hub"
  },
  {
    "title": "16 Avenue NW (TCH)",
    "url": "https://www.google.com/maps/place/16+Avenue+NW,+Calgary,+AB/",
    "description": "Trans-Canada corridor with quick access"
  }
];
...
const faqs = [
  ...
  },
  {
    ...
    answer: `Around Highland Park we offer the full range:\n\n• Commercial Cleaning\n• Standard & Deep Cleaning Packages\n• Move-In & Move-Out Cleaning\n• Post-Construction Cleaning\n• Wall Washing and Wall Cleaning`
  },
  {
    question: "Do you offer discounts?",
    answer: `Yes — recurring Highland Park customers save:\n\n• Every week: 20% off\n• Every two weeks: 15% off\n• Every four weeks: 10% off`
  },
  {
    question: "What's included in a deep cleaning?",
    answer: `A Highland Park deep clean adds to the standard package:\n\n• Wall outlet covers wiped\n• Cobweb removal\n• Ceiling fans dusted and cleaned\n• Light switches fully cleaned\n• All reachable vents cleaned\n• And more!`
  },
  {
    question: "What is your 100% satisfaction guarantee policy?",
    answer: "If you're not 100% satisfied, call us within 24 hours and we'll come back to your Highland Park home and make it right — at no extra cost!"
  }
];
...
export default function HighlandPark() {
  useEffect(() => {
    document.title = "House Cleaning Services Highland Park | Duty Cleaners";
    window.scrollTo(0, 0);
  }, []);
  ...
  return (
    <>
      <Helmet>
        <title>House Cleaning in Highland Park, Calgary | Duty Cleaners</title>
        <meta name="description" content="Professional house cleaning in Highland Park, Calgary. Same-day service subject to availability. 100% satisfaction guaranteed. Pay after your clean." />
        <meta property="og:title" content="House Cleaning Services Highland Park Calgary | Duty Cleaners" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="House Cleaning Services Highland Park Calgary | Duty Cleaners" />
        <meta name="twitter:description" content="Professional house cleaning in Highland Park, Calgary. Same-day service subject to availability. 100% satisfaction guaranteed." />
        <meta property="og:description" content="Professional house cleaning in Highland Park, Calgary. Same-day service subject to availability. 100% satisfaction guaranteed." />
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-5 py-2 mb-6">
                ...
                <span className="text-white/90 text-sm font-medium">Serving Highland Park, N Calgary</span>
              </div>
            ...
            <AnimatedSection>
              <div className="text-center mb-14">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
                  From routine upkeep to move-outs, Highland Park homes get every service they need.
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection>
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="text-center mb-14 max-w-3xl mx-auto">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-2 mb-4">Around Highland Park</h2>
                <p className="text-muted-foreground text-lg">
                  We know the area inside and out — here are a few of the places that make Highland Park feel like home.
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection>
            ...
            <AnimatedSection>
              <div className="max-w-5xl mx-auto">
                ...
                <div className="rounded-2xl overflow-hidden shadow-xl border border-border">
                  <iframe
                    src="https://www.google.com/maps?q=Highland+Park,+Calgary,+AB&output=embed"
                    width="100%"
                    height="450"
                    style={{ border: 0 }}
                    allowFullScreen
                    ...
                    title="Highland Park Calgary Service Area Map"
                  />
                </div>
              </div>
            </AnimatedSection>
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="text-center mb-10">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto">
                  We proudly serve families and homeowners across Highland Park and surrounding N Calgary communities.
                </p>
              </div>
      ...
      <LocationPricing />
            ...
            <AnimatedSection>
              <div className="text-center mb-14">
                ...
                <p className="text-white/90 max-w-2xl mx-auto text-lg">
                  Trusted by Highland Park families for reliable, thorough cleaning.
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection>
        ...
        <section className="py-20 bg-brand-navy relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            <AnimatedSection>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Ready for a Spotless Home in Highland Park?</h2>
