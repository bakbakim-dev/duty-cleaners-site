...
import cleanHomeImg from "@/assets/gallery/neighborhoods/altadore.jpg";
            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <div className="text-muted-foreground space-y-4 text-lg leading-relaxed">
                  ...
                  <p>
                    From contemporary infills to character bungalows, we tailor every visit to your space — using non-toxic products that are safe for kids, pets, and the people you love most.
                  </p>
                </div>
              </div>
            </AnimatedSection>
