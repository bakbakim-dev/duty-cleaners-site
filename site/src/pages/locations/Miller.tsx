  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional house cleaning in Miller, Edmonton. Trusted local cleaners serving northeast Edmonton families. Customer-rated cleaners and five-star rated service." />
