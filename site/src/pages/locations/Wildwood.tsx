...
const services = [
  { icon: Home, title: "Standard Cleaning", description: "Weekly or bi-weekly upkeep that keeps your Wildwood bungalow fresh and dust-free.", to: "/calgary/regular-cleaning/", linkText: "Standard cleaning in Wildwood" },
          ...
          <div className="container mx-auto px-4">
            ...
            <AnimatedSection>
              ...
              <p className="mt-10 text-center text-muted-foreground">
                {"Wildwood is one of the Calgary neighbourhoods we clean — see "}
                <Link
