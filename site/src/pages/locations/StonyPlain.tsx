...
// maths: a two-bedroom bungalow, outside Edmonton city limits. The table rounds
// each size to the dollar, so no total is built from a table card.
...
const services = locationServices("Stony Plain", "edmonton");
...
export default function StonyPlain() {
  const faqs = [
    ...
    },
    {
      ...
      answer: `No. The team brings all supplies and equipment. Optional alternative products cost ${POLICY.ecoProductsFee} extra, before GST: ${POLICY.ecoProductsHowToRequest}. Running water is required, and vacuuming may not be possible without electricity.`
    },
    {
          ...
          <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-lg text-white/85 mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                A standard clean in Stony Plain is {STANDARD_FROM} to {STANDARD_TOP} before GST by bedroom count, priced for an apartment or condo, plus the {TRAVEL_FEE} travel fee and any house-type or pet charge, and you pay after the clean.
              </p>
          ...
          <AnimatedSection>
            <div className="max-w-4xl mx-auto">
              ...
              <div className="text-muted-foreground text-lg leading-relaxed space-y-4">
                <p>
                  Say a two-bedroom, two-bathroom bungalow in Stony Plain is being handed back to its landlord.
                </p>
                <QuoteReceipt
                  lines={[
                    { label: "Move-in and move-out rate for that size, set for an apartment or condo", amount: EXAMPLE_BASE, note: EXAMPLE_TABLE_NOTE },
                  ...
                  extras={[
                    { label: "A home with pets: the compulsory pet charge, shown on the quote before booking", amount: `+ ${PET_FEE}` },
                  ]}
                />
        ...
        <div className="container mx-auto px-4">
          <AnimatedSection>
            ...
            <div className="max-w-4xl mx-auto rounded-2xl overflow-hidden shadow-xl">
              <GoogleMapEmbed query="Stony Plain, AB" title="Stony Plain Service Area Map" />
            </div>
          </AnimatedSection>
        </div>
      </section>
            ...
            <AnimatedSection>
              <div className="max-w-3xl mx-auto">
                <div className="text-center mb-12">
                  <h2 className="display-serif text-3xl md:text-4xl font-bold text-foreground mb-4 text-balance">Stony Plain house cleaning questions</h2>
                </div>
