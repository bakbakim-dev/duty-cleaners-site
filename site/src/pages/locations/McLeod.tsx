...
import heroImg from "@/assets/gallery/mcleod-cleaner-kitchen.jpg";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional house cleaning in McLeod, Edmonton. Trusted local cleaners serving northeast Edmonton families. Customer-rated cleaners and five-star rated service." />
