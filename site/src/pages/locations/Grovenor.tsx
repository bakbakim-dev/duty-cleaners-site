...
import heroImg from "@/assets/gallery/grovenor-cleaner.webp";
...
const services = [
  { icon: Home, title: "Standard Cleaning", description: "A thorough one-time cleaning that leaves your Grovenor home spotless and fresh.", to: "/edmonton/regular-cleaning/", linkText: "Standard cleaning in Grovenor" },
  { icon: Sparkles, title: "Deep Cleaning", description: "Top-to-bottom detail that reaches what weekly cleaning never does.", to: "/edmonton/deep-cleaning/", linkText: "Deep cleaning in Grovenor" },
  { icon: Truck, title: "Move In/Out Cleaning", description: "Detailed cleaning for a smooth Grovenor move — leave or arrive to a pristine home.", to: "/move-out-cleaning-edmonton/", linkText: "Move-out cleaning in Grovenor" },
  { icon: SprayCan, title: "Post-Construction Cleanup", description: "Post-renovation dust and debris, professionally removed.", to: "/post-construction-cleaning/", linkText: "Post-construction cleaning in Grovenor" },
  { icon: PaintRoller, title: "Wall Washing", description: "Scuffs, handprints and cooking film off painted walls, without stripping the finish.", to: "/wall-washing-wall-cleaning/", linkText: "Wall washing in Grovenor" },
  ...
  { icon: CalendarCheck, title: "Recurring Cleaning", description: `The standard checklist on a schedule, from ${RECURRING_FROM} a visit. From the second clean on, weekly takes ${OFF_WEEKLY} off, every two weeks ${OFF_BIWEEKLY} and every four weeks ${OFF_FOUR_WEEKLY}.`, to: "/edmonton/recurring-cleaning/", linkText: "Recurring cleaning in Grovenor" },
];
...
const whyUsItems = [
  ...
  { icon: Clock, title: "Flexible Scheduling", description: "Same-day and next-day availability in Grovenor. We work around your busy life." },
...
export default function Grovenor() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  const faqs = [
    ...
    },
    {
      ...
      answer: "If you're not 100% satisfied, call us within 24 hours and we'll come back to your Grovenor home and make it right — at no extra cost!"
    }
  ];
  const faqJsonLd = {
            ...
            <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12">
              <div className="flex-1 text-center lg:text-left">
                <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-5 py-2 mb-6">
                  ...
                  <span className="text-white/90 text-sm font-medium">Serving Grovenor, Edmonton</span>
                </div>
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
                  Professional House Cleaning in Grovenor
                </h1>
                <p className="text-lg md:text-xl text-white/80 mb-10 max-w-3xl leading-relaxed">
                  From the heritage character homes along 102 Avenue to the leafy walk-ups near Stony Plain Road — we keep Grovenor homes shining with hometown care.
                </p>
              ...
              <div className="lg:w-[500px] flex-shrink-0">
                <img
                  src={heroImg}
                  alt="Professional cleaner working in a Grovenor, Edmonton home"
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-2 mb-6">Residential Cleaning in Grovenor</h2>
          ...
          <div className="container mx-auto px-4">
            ...
            <AnimatedSection>
              ...
              <p className="mt-10 text-center text-muted-foreground">
                {"Grovenor is one of the Edmonton neighbourhoods we clean — see "}
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="max-w-4xl mx-auto text-center mb-10">
                ...
                <h2 className="text-3xl font-bold text-foreground mt-2 mb-4">Serving the Grovenor Area</h2>
                <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                  Steps from Stony Plain Road and Coronation Park — we're a familiar face in the neighbourhood.
                </p>
              </div>
            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                <div className="text-center mb-10">
                  ...
                  <h2 className="text-3xl font-bold text-foreground mt-2 mb-4">We Know Grovenor</h2>
                  <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                    We're in and around the neighbourhood daily, so we know the area well.
                  </p>
                </div>
                <CoverageChips areas={["Grovenor Community League", "Stony Plain Road", "Coronation Park", "142 Street", "102 Avenue", "Crestwood", "Glenora", "Westmount"]} variant="compact" />
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            <AnimatedSection>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Ready for a Spotless Home in Grovenor?
              </h2>
