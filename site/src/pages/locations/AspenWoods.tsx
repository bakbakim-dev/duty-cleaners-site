...
const services = [
  { icon: Home, title: "Standard Cleaning", description: "A thorough one-time cleaning to refresh your luxury Aspen Woods home spotless and fresh." },
  { icon: Sparkles, title: "Deep Cleaning", description: "Thorough top-to-bottom cleaning — perfect for granite countertops, hardwood floors, and premium finishes." },
  { icon: Truck, title: "Move In/Out Cleaning", description: "Detailed cleaning for smooth transitions in Aspen Woods' active real estate market." },
  { icon: SprayCan, title: "Post-Construction Cleanup", description: "Expert dust and debris removal after renovations or remodels in your estate home." },
...
const faqs = [
  ...
  { question: "What cleaning services does Duty Cleaners offer in Aspen Woods?", answer: "Whenever you choose Duty Cleaners, you'll have an expert taking care of your home or business. We offer:\n\n• Commercial Cleaning\n• Standard Cleaning & Deep Cleaning Packages\n• Move-In And Move-Out Cleaning Service\n• Post Construction Cleaning\n• Wall Washing and Wall Cleaning" },
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:description" content="Premium house cleaning in Aspen Woods, Calgary. Same-day service available. 100% satisfaction guaranteed." />
            ...
            <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
              ...
              <div className="flex-shrink-0 w-full lg:w-[500px]">
                <img
                  ...
                  alt="Luxury estate home in Aspen Woods Calgary with mountain views"
