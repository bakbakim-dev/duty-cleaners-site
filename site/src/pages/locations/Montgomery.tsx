...
import cleanHomeImg from "@/assets/gallery/neighborhoods/montgomery.jpg";
...
export default function Montgomery() {
  ...
  return (
    <>
      <Helmet>
        <title>House Cleaning Services in Montgomery, Calgary | Duty Cleaners</title>
            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <div className="text-muted-foreground space-y-4 text-lg leading-relaxed">
                  ...
                  <p>Whether you're in a renovated bungalow on Bowness Road or a brand-new duplex off 16th Ave, our team brings the same careful, consistent service. Non-toxic products, trained cleaners, and a satisfaction guarantee — every visit.</p>
                </div>
              </div>
            </AnimatedSection>
          </div>
