...
const whyUsItems = [
  ...
  { icon: Clock, title: "Flexible Scheduling", description: "Same-day and next-day availability in Montgomery. We work around your busy life." },
...
const faqs = [
  {
    ...
    answer: `We work to a checklist, not a clock. Your Montgomery team stays until every task in your service scope is complete, and your flat rate does not change based on how long it takes.`
  },
  {
    question: "What cleaning services does Duty Cleaners offer in Montgomery?",
    answer: `Around Montgomery we offer the full range:\n\n• Commercial Cleaning\n• Standard & Deep Cleaning Packages\n• Move-In & Move-Out Cleaning\n• Post-Construction Cleaning\n• Wall Washing and Wall Cleaning`
  },
  {
    question: "Do you offer discounts?",
    answer: `Yes — recurring Montgomery customers save:\n\n• Every week: 20% off\n• Every two weeks: 15% off\n• Every four weeks: 10% off`
  },
  {
    question: "What's included in a deep cleaning?",
    answer: `A Montgomery deep clean adds to the standard package:\n\n• Wall outlet covers wiped\n• Cobweb removal\n• Ceiling fans dusted and cleaned\n• Light switches fully cleaned\n• All reachable vents cleaned\n• And more!`
  },
  {
    question: "What is your 100% satisfaction guarantee policy?",
    answer: "If you're not 100% satisfied, call us within 24 hours and we'll come back to your Montgomery home and make it right — at no extra cost!"
  }
];
...
export default function Montgomery() {
  useEffect(() => {
    document.title = "House Cleaning Services Montgomery | Duty Cleaners";
    window.scrollTo(0, 0);
  }, []);
  ...
  return (
    <>
      <Helmet>
        <title>House Cleaning in Montgomery, Calgary | Duty Cleaners</title>
        <meta name="description" content="Professional house cleaning in Montgomery, Calgary. Same-day service subject to availability. 100% satisfaction guaranteed. Pay after your clean." />
        <meta property="og:title" content="House Cleaning Services Montgomery Calgary | Duty Cleaners" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="House Cleaning Services Montgomery Calgary | Duty Cleaners" />
        <meta name="twitter:description" content="Professional house cleaning in Montgomery, Calgary. Same-day service subject to availability. 100% satisfaction guaranteed." />
        <meta property="og:description" content="Professional house cleaning in Montgomery, Calgary. Same-day service subject to availability. 100% satisfaction guaranteed." />
            ...
            <AnimatedSection>
              <div className="text-center mb-14">
                ...
                <p className="text-white/90 max-w-2xl mx-auto text-lg">
                  Trusted by Montgomery families for reliable, thorough cleaning.
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection>
