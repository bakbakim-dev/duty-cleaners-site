...
import morinvilleHome from "@/assets/gallery/morinville-home.jpg";
          ...
          <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
            <div className="flex-1 text-center lg:text-left">
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-5 py-2 mb-6">
                ...
                <span className="text-white/90 text-sm font-medium">Serving Morinville, Edmonton Region</span>
              </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="text-muted-foreground space-y-4 text-lg leading-relaxed">
                ...
                <p>
                  ...
                  we provide flexible scheduling and non-toxic cleaning solutions suited to every household in Morinville.
                </p>
              </div>
            </div>
          </AnimatedSection>
          ...
          <AnimatedSection>
            <div className="text-center mb-14">
              ...
              <p className="text-white/90 max-w-2xl mx-auto text-lg">
                Trusted by families across the Edmonton region for reliable, thorough, and non-toxic cleaning.
              </p>
            </div>
          </AnimatedSection>
          <AnimatedSection>
