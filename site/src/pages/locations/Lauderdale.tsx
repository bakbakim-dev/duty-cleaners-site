...
import heroImg from "@/assets/gallery/lauderdale-cleaner.webp";
...
const services = [
  { icon: Home, title: "Standard Cleaning", description: "A one-time clean of every room, priced flat by home size.", to: "/edmonton/regular-cleaning/", linkText: "Standard cleaning in Lauderdale" },
  { icon: Sparkles, title: "Deep Cleaning", description: "The standard checklist plus the deep-clean package: cobwebs, ceiling fans, light switches, outlet covers and vent covers.", to: "/edmonton/deep-cleaning/", linkText: "Deep cleaning in Lauderdale" },
  { icon: Truck, title: "Move In/Out Cleaning", description: "Inside the oven, fridge and microwave, and inside every cabinet, drawer and closet.", to: "/move-out-cleaning-edmonton/", linkText: "Move-out cleaning in Lauderdale" },
  { icon: SprayCan, title: "Post-Construction Cleanup", description: "Dust and debris cleaned up after a renovation in Lauderdale, priced by square footage.", to: "/post-construction-cleaning/", linkText: "Post-construction cleaning in Lauderdale" },
  { icon: PaintRoller, title: "Wall Washing", description: "Scuffs, handprints and cooking film off painted walls, without stripping the finish.", to: "/wall-washing-wall-cleaning/", linkText: "Wall washing in Lauderdale" },
  ...
  { icon: CalendarCheck, title: "Recurring Cleaning", description: `The standard checklist on a schedule, from ${RECURRING_FROM} a visit for a one-bedroom, one-bathroom apartment, before 5% GST and any pet or home-type charge. From the second clean on, weekly takes ${OFF_WEEKLY} off, every two weeks ${OFF_BIWEEKLY} and every four weeks ${OFF_FOUR_WEEKLY}.`, to: "/edmonton/recurring-cleaning/", linkText: "Recurring cleaning in Lauderdale" },
];
...
export default function Lauderdale() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  const faqs = [
    ...
    },
    {
      ...
      answer: "Tell us within 24 hours and the team comes back to your Lauderdale home to re-clean what was missed, at no charge. Photos help but are not required."
    }
  ];
  const faqJsonLd = {
  ...
  return (
    <>
      <Helmet>
        <title>House Cleaning in Lauderdale, Edmonton | Duty Cleaners</title>
        <meta name="description" content="Many 1950s-60s bungalows in Lauderdale, Edmonton keep first-generation enamel, tile and chrome kitchens and baths; we clean them at flat rates." />
        <script type="application/ld+json">
          {JSON.stringify(buildLocationSchema({
  name: "Duty Cleaners – Lauderdale, Edmonton",
  city: "edmonton",
  url: "https://dutycleaners.ca/locations/lauderdale",
  areaServed: "Lauderdale, Edmonton, AB",
  description: "Many 1950s-60s bungalows in Lauderdale, Edmonton keep first-generation enamel, tile and chrome kitchens and baths; we clean them at flat rates.",
  geo: { latitude: "53.591", longitude: "-113.504" },
        ...
        <meta property="og:description" content="Many 1950s-60s bungalows in Lauderdale, Edmonton keep first-generation enamel, tile and chrome kitchens and baths; we clean them at flat rates." />
        ...
        <meta name="twitter:description" content="Many 1950s-60s bungalows in Lauderdale, Edmonton keep first-generation enamel, tile and chrome kitchens and baths; we clean them at flat rates." />
      </Helmet>
            ...
            <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12">
              <div className="flex-1 text-center lg:text-left">
                <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-5 py-2 mb-6">
                  ...
                  <span className="text-white/90 text-sm font-medium">Serving Lauderdale, Edmonton</span>
                </div>
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
                  Professional House Cleaning in Lauderdale
                </h1>
                <p className="text-lg md:text-xl text-white/80 mb-10 max-w-3xl leading-relaxed">
                  Many of Lauderdale's 1950s-60s bungalows still have their first-generation kitchens and baths, in enamel, tile and chrome. Our Edmonton branch cleans them at flat rates by home size, with no trip fee inside city limits.
                </p>
              ...
              <div className="lg:w-[500px] flex-shrink-0">
                <img
                  src={heroImg}
                  alt="Woman vacuuming a rug in a sunlit living room with orange sofas and a ceiling fan"
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="text-center mb-14">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-2 mb-4">
                  Cleaning Services for Lauderdale Homes
                </h2>
                <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
                  Lauderdale bookings run from a single standard clean to a weekly schedule, and each one is a flat rate by home size before 5% GST.
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection>
            ...
            <AnimatedSection>
              ...
              <p className="mt-10 text-center text-muted-foreground">
                {"Lauderdale is one of the Edmonton neighbourhoods we clean — see "}
            ...
            <AnimatedSection>
              <div className="text-center mb-14">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-white mt-2 mb-4">
                  Why Lauderdale Residents Choose Duty Cleaners
                </h2>
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="max-w-4xl mx-auto text-center mb-10">
                ...
                <h2 className="text-3xl font-bold text-foreground mt-2 mb-4">Serving the Lauderdale Area</h2>
                <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                  Lauderdale sits between the 97 Street commercial strip and the Blatchford redevelopment on the old airport lands, so construction seasons come and go on its edges.
                </p>
              </div>
              <div className="max-w-4xl mx-auto rounded-2xl overflow-hidden shadow-lg border border-border">
                <Suspense fallback={<div className="w-full h-[400px] bg-muted animate-pulse rounded-2xl" />}>
                  <LocationMap center={[53.591, -113.504]} label="Lauderdale, Edmonton" />
                </Suspense>
              </div>
            </AnimatedSection>
          </div>
            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                <div className="text-center mb-10">
                  ...
                  <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                    Prince Charles is also one of the 80 Edmonton neighbourhoods on our Edmonton branch's list.
                  </p>
                </div>
                <CoverageChips areas={["Prince Charles"]} variant="compact" />
      ...
      <LocalMarketNote
        ...
        paragraphs={[
          "Many of Lauderdale's 1950s-60s bungalows keep their first-generation kitchens and baths — enamel, tile and chrome.",
          "The neighbourhood sits between 97 Street's commercial strip and the airport lands' redevelopment, so construction seasons come and go on its edges. When Blatchford's build phases run, south-facing tracks and sills carry the evidence.",
        ]}
      />
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            <AnimatedSection>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Ready to Book a Clean in Lauderdale?
              </h2>
