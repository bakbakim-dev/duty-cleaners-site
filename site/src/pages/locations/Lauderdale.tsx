...
const services = [
  { icon: Home, title: "Standard Cleaning", description: "A thorough one-time cleaning for a spotless, fresh reset in one visit.", to: "/edmonton/regular-cleaning/", linkText: "Standard cleaning in Lauderdale" },
  { icon: Sparkles, title: "Deep Cleaning", description: "A full top-to-bottom reset — corners, baseboards, and the surfaces regular visits skip.", to: "/edmonton/deep-cleaning/", linkText: "Deep cleaning in Lauderdale" },
  { icon: Truck, title: "Move In/Out Cleaning", description: "Move-day cleaning done to the standard landlords check for.", to: "/move-out-cleaning-edmonton/", linkText: "Move-out cleaning in Lauderdale" },
  { icon: SprayCan, title: "Post-Construction Cleanup", description: "Post-renovation dust and debris, professionally removed.", to: "/post-construction-cleaning/", linkText: "Post-construction cleaning in Lauderdale" },
  ...
  { icon: CalendarCheck, title: "Recurring Cleaning", description: `The standard checklist on a schedule, from ${RECURRING_FROM} a visit. From the second clean on, weekly takes ${OFF_WEEKLY} off, every two weeks ${OFF_BIWEEKLY} and every four weeks ${OFF_FOUR_WEEKLY}.`, to: "/edmonton/recurring-cleaning/", linkText: "Recurring cleaning in Lauderdale" },
];
...
const whyUsItems = [
  ...
  { icon: Clock, title: "Flexible Scheduling", description: "Same-day and next-day availability in Lauderdale. We work around your busy life." },
...
export default function Lauderdale() {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional house cleaning in Lauderdale, Edmonton. Trusted local cleaners, customer-rated, serving Lauderdale homes." />
  ...
  geo: { latitude: "53.591", longitude: "-113.504" },
        ...
        <meta property="og:description" content="Professional house cleaning in Lauderdale, Edmonton. Trusted local cleaners, customer-rated, serving Lauderdale homes." />
        ...
        <meta name="twitter:description" content="Professional house cleaning in Lauderdale, Edmonton. Trusted local cleaners, customer-rated, serving Lauderdale homes." />
      </Helmet>
            ...
            <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12">
              <div className="flex-1 text-center lg:text-left">
                ...
                <p className="text-lg md:text-xl text-white/80 mb-10 max-w-3xl leading-relaxed">
                  From cozy 1950s bungalows to updated family homes near Lauderdale Park — bring lasting freshness to your north Edmonton home.
                </p>
              ...
              <div className="lg:w-[500px] flex-shrink-0">
                <img
                  src={heroImg}
                  alt="Professional cleaner working in a Lauderdale, Edmonton home"
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-2 mb-6">Residential Cleaning in Lauderdale</h2>
            ...
            <AnimatedSection>
              <div className="text-center mb-14">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
                  From routine upkeep to move-outs, Lauderdale homes get every service they need.
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection>
            ...
            <AnimatedSection>
              <div className="text-center mb-14">
                ...
                <p className="text-white/90 max-w-2xl mx-auto text-lg">
                  Trusted by Lauderdale families for reliable, thorough cleaning.
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection>
            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto text-center mb-10">
                ...
                <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                  A peaceful north Edmonton pocket — we're always nearby.
                </p>
              </div>
            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                <div className="text-center mb-10">
                  ...
                  <h2 className="text-3xl font-bold text-foreground mt-2 mb-4">We Know Lauderdale</h2>
                  <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                    We're in and around the neighbourhood daily, so we know the area well.
                  </p>
                </div>
                <CoverageChips areas={["Lauderdale Park", "Lauderdale Community League", "127 Street", "Yellowhead Trail", "132 Avenue", "Prince Charles", "Calder", "Athlone"]} variant="compact" />
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            <AnimatedSection>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Ready for a Spotless Home in Lauderdale?
              </h2>
