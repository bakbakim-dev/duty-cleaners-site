...
const services = locationServices("Scenic Acres", "calgary", ["standard", "deep", "move-out", "post-construction", "wall-washing"]);
          ...
          <div className="container mx-auto px-4">
            ...
            <AnimatedSection>
              ...
              <p className="mt-10 text-center text-muted-foreground">
                {"Scenic Acres is one of the Calgary neighbourhoods we clean — see "}
                <Link
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            <AnimatedSection>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Ready to Book a Clean in Scenic Acres?
              </h2>
