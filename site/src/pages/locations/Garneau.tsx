...
import garneauCleanerImg from "@/assets/gallery/garneau-cleaner-apartment.jpg";
...
const services = [
  { icon: Home, title: "Standard Cleaning", description: "A thorough one-time cleaning to refresh your Garneau home fresh and inviting year-round." },
  ...
  { icon: Truck, title: "Move In/Out Cleaning", description: "Perfect for students and families transitioning — leave or arrive to a pristine home." },
...
export default function Garneau() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  const faqs = [
      ...
      <div className="min-h-screen">
            ...
            <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12">
              <div className="flex-1 text-center lg:text-left">
                <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-5 py-2 mb-6">
                  ...
                  <span className="text-white/90 text-sm font-medium">Serving Garneau, Edmonton</span>
                </div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <AnimatedSection>
              <div className="text-center mb-14">
                ...
                <p className="text-white/90 max-w-2xl mx-auto text-lg">Trusted by families and students across Edmonton for reliable, thorough, and non-toxic cleaning.</p>
              </div>
            </AnimatedSection>
            <AnimatedSection>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                <div className="text-center mb-10">
                  ...
                  <h2 className="text-3xl font-bold text-foreground mt-2 mb-4">Garneau Service Area</h2>
                </div>
                <div className="rounded-2xl overflow-hidden shadow-xl border border-primary/10">
                  <iframe
                    title="Garneau Edmonton Map"
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d9460!2d-113.525!3d53.525!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x53a0220e3b6b4e7d%3A0x1!2sGarneau%2C+Edmonton%2C+AB!5e0!3m2!1sen!2sca!4v1"
        ...
        <section className="py-20 bg-brand-navy relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            <AnimatedSection>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Ready for a Spotless Home in Garneau?</h2>
