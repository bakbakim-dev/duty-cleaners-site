...
import cleanHomeImg from "@/assets/gallery/neighborhoods/mayfair.jpg";
            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <div className="text-muted-foreground space-y-4 text-lg leading-relaxed">
                  ...
                  <p>We treat Mayfair homes with the meticulous detail they deserve — thoughtful, consistent service tailored to fine finishes, and non-toxic products you'll feel good about using around family and guests.</p>
                </div>
              </div>
            </AnimatedSection>
          </div>
