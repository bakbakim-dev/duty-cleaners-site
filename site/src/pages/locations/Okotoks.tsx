...
const services = locationServices("Okotoks", "calgary", ["standard", "deep", "move-out", "post-construction", "wall-washing"]);
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                <h2 className="display-serif text-2xl md:text-3xl font-bold text-foreground mb-6 text-balance">Okotoks Service Area</h2>
