...
const services = [
  { icon: Home, title: "Standard Cleaning", description: "A thorough one-time cleaning to refresh your Rapperswill home spotless and fresh year-round." },
  { icon: Sparkles, title: "Deep Cleaning", description: "Thorough top-to-bottom cleaning of your Rapperswill home — every corner, baseboard, and hidden surface." },
  { icon: Truck, title: "Move In/Out Cleaning", description: "Detailed cleaning for a smooth Rapperswill move — leave or arrive to a pristine home." },
  { icon: SprayCan, title: "Post-Construction Cleanup", description: "Expert dust and debris removal after renovations or new builds around Rapperswill." },
...
const whyUsItems = [
  ...
  { icon: Clock, title: "Flexible Scheduling", description: "Same-day and next-day availability in Rapperswill. We work around your busy life." },
...
export default function Rapperswill() {
  ...
  const faqs = [
    {
      ...
      answer: `We work to a checklist, not a clock. Your Rapperswill team stays until every task in your service scope is complete, and your flat rate does not change based on how long it takes.`
    },
    {
    ...
    },
    {
      ...
      answer: `Yes — recurring Rapperswill customers save:\n\n• Every week: 20% off\n• Every two weeks: 15% off\n• Every four weeks: 10% off`
    },
    {
      question: "What's included in a deep cleaning?",
      answer: `A Rapperswill deep clean adds to the standard package:\n\n• Wall outlet covers wiped\n• Cobweb removal\n• Ceiling fans dusted and cleaned\n• Light switches fully cleaned\n• All reachable vents cleaned\n• And more!`
    },
    {
      question: "What is your 100% satisfaction guarantee policy?",
      answer: "If you're not 100% satisfied, call us within 24 hours and we'll come back to your Rapperswill home and make it right — at no extra cost!"
    }
  ];
  const faqJsonLd = {
  ...
  return (
    <>
      <Helmet>
        <title>House Cleaning in Rapperswill, Edmonton | Duty Cleaners</title>
        <meta name="description" content="Professional house cleaning in Rapperswill, Edmonton. Trusted local cleaners serving Rapperswill homes with reliable, customer-rated cleaning service." />
  ...
  description: "Professional house cleaning services in Rapperswill, Edmonton.",
  geo: { latitude: "53.631", longitude: "-113.55" },
}))}
        </script>
        <link rel="canonical" href="https://dutycleaners.ca/locations/rapperswill-edmonton/" />
        <meta property="og:title" content="House Cleaning in Rapperswill, Edmonton | Duty Cleaners" />
        <meta property="og:description" content="Professional house cleaning in Rapperswill, Edmonton. Trusted local cleaners serving Rapperswill homes with reliable, customer-rated cleaning service." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://dutycleaners.ca/locations/rapperswill-edmonton/" />
        <meta property="og:image" content="https://dutycleaners.ca/og-image.jpg" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="House Cleaning in Rapperswill, Edmonton | Duty Cleaners" />
        <meta name="twitter:description" content="Professional house cleaning in Rapperswill, Edmonton. Trusted local cleaners serving Rapperswill homes with reliable, customer-rated cleaning service." />
      </Helmet>
            ...
            <AnimatedSection>
              <div className="text-center mb-14">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
                  From routine upkeep to move-outs, Rapperswill homes get every service they need.
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection>
            ...
            <AnimatedSection>
              <div className="text-center mb-14">
                ...
                <p className="text-white/90 max-w-2xl mx-auto text-lg">
                  Trusted by Rapperswill families for reliable, thorough cleaning.
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection>
