          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 max-w-6xl mx-auto">
            <div className="flex-1 text-center lg:text-left">
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-5 py-2 mb-6">
                ...
                <span className="text-white/90 text-sm font-medium">Serving Fort Saskatchewan, Edmonton</span>
              </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="prose prose-lg text-muted-foreground max-w-none space-y-4">
                ...
                <p>
                  ...
                  deserve a home that's just as clean and welcoming as the community around them. We bring non-toxic products and meticulous attention to detail to every Fort Saskatchewan home we service.
                </p>
                <p>
          ...
          <AnimatedSection>
            <div className="max-w-4xl mx-auto">
              ...
              <div className="text-muted-foreground text-lg leading-relaxed space-y-4">
                <p>Settled along the picturesque North Saskatchewan River, Fort Saskatchewan, Alberta, captivates with its unique blend of rich history, natural beauty, and vibrant community. The city has a legacy of fur trading. It traces its roots back to the early 19th century when it served as a vital outpost for the Hudson's Bay Company. Today, Fort Saskatchewan is a thriving industrial and cultural hub known for its petrochemical industry and impressive Dow Centennial Centre, which houses a theatre, art gallery, and fitness facilities.</p>
