...
import cleanHomeImg from "@/assets/gallery/calgary-kitchen-clean.webp";
...
const services = [
  ...
  { icon: Sparkles, title: "Deep Cleaning", description: "The standard checklist plus the deep-clean package: baseboards, doors, light switches, wall outlets and vent covers.", to: "/calgary/deep-cleaning/", linkText: "Deep cleaning in Mission" },
  ...
  { icon: PaintRoller, title: "Wall Washing", description: WALL_WASHING_DESCRIPTION, to: "/wall-washing-wall-cleaning-calgary/", linkText: "Wall washing in Mission" },
];
              ...
              <div className="max-w-4xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-10 items-center">
                  <div className="rounded-2xl overflow-hidden shadow-xl">
                    <img width={800} height={800} src={cleanHomeImg} alt="Kitchen with granite counters and a gas cooktop, opening onto a dining table by tall windows" className="w-full h-full object-cover aspect-[4/3]" loading="lazy" />
                  </div>
                  <div className="rounded-2xl overflow-hidden shadow-xl">
                    <GoogleMapEmbed query="Mission, Calgary, AB" title="Mission Calgary Service Area Map" />
                  </div>
                </div>
              </div>
            </AnimatedSection>
          ...
          <div className="container mx-auto px-4">
            ...
            <AnimatedSection>
              ...
              <p className="mt-10 text-center text-muted-foreground">
                {"Mission is one of the Calgary neighbourhoods we clean — see "}
                <Link
