...
import cochraneImg from "@/assets/gallery/cochrane-clean-home.jpg";
              ...
              <div className="max-w-4xl mx-auto">
                ...
                <div className="text-muted-foreground space-y-4 text-lg leading-relaxed">
                  ...
                  <p>
                    ...
                    we provide flexible scheduling and non-toxic cleaning solutions suited to every household in Cochrane.
                  </p>
                </div>
              </div>
            </AnimatedSection>
