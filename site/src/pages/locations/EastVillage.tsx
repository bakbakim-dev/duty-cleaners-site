...
export default function EastVillage() {
  ...
  return (
    <>
      <Helmet>
        <title>House Cleaning Services in East Village, Calgary | Duty Cleaners</title>
            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <div className="text-muted-foreground space-y-4 text-lg leading-relaxed">
                  ...
                  <p>
                    From compact studios to spacious family condos, we tailor every visit to your space — using non-toxic products that are safe for kids, pets, and the people you love most.
                  </p>
                </div>
              </div>
            </AnimatedSection>
