...
import cleanHomeImg from "@/assets/gallery/neighborhoods/spruce-cliff.jpg";
...
export default function SpruceCliff() {
  ...
  return (
    <>
      <Helmet>
        <title>House Cleaning Services in Spruce Cliff, Calgary | Duty Cleaners</title>
            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <div className="text-muted-foreground space-y-4 text-lg leading-relaxed">
                  ...
                  <p>Whether you're in a sleek view condo or a townhome, our team delivers consistent, careful service. Non-toxic products keep things safe for kids, pets, and your indoor air quality.</p>
                </div>
              </div>
            </AnimatedSection>
          </div>
