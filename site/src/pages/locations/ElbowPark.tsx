...
import cleanHomeImg from "@/assets/gallery/neighborhoods/elbow-park.jpg";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional house cleaning in Elbow Park, Calgary. Same-day service available. 100% satisfaction guaranteed. Pay after your clean. Get a free quote today!" />
        <meta property="og:title" content="House Cleaning Services Elbow Park Calgary | Duty Cleaners" />
        <meta property="og:description" content="Professional house cleaning in Elbow Park, Calgary. Same-day service available. 100% satisfaction guaranteed." />
            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <div className="text-muted-foreground space-y-4 text-lg leading-relaxed">
                  ...
                  <p>
                    From stately estates to riverside bungalows, we tailor every visit to your space — using non-toxic products that are safe for kids, pets, and the people you love most.
                  </p>
                </div>
              </div>
            </AnimatedSection>
