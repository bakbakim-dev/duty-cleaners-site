...
import cleanHomeImg from "@/assets/gallery/neighborhoods/elbow-park.webp";
...
const services = [
  { icon: Home, title: "Standard Cleaning", description: "A thorough one-time cleaning to refresh your Elbow Park home spotless year-round.", to: "/calgary/regular-cleaning/", linkText: "Standard cleaning in Elbow Park" },
  { icon: Sparkles, title: "Deep Cleaning", description: "Thorough top-to-bottom cleaning of your Elbow Park home — every corner, baseboard, and hidden surface.", to: "/calgary/deep-cleaning/", linkText: "Deep cleaning in Elbow Park" },
  { icon: Truck, title: "Move In/Out Cleaning", description: "Inspection-grade detail for moving out or settling in.", to: "/move-out-cleaning-calgary/", linkText: "Move-out cleaning in Elbow Park" },
...
const whyUsItems = [
  ...
  { icon: Clock, title: "Flexible Scheduling", description: "Same-day and next-day availability in Elbow Park. We work around your busy life." },
...
const landmarks = [
  { title: "Elbow Park Tennis Club", url: "https://www.google.com/maps/place/Elbow+Park+Tennis+Club,+Calgary,+AB/", description: "Historic community club along the Elbow River" },
  { title: "Stanley Park", url: "https://www.google.com/maps/place/Stanley+Park,+Calgary,+AB/", description: "Beloved riverside park with pools and pathways" },
  { title: "River Park", url: "https://www.google.com/maps/place/River+Park,+Calgary,+AB/", description: "Off-leash dog park with sweeping city views" },
  { title: "Glencoe Club", url: "https://www.google.com/maps/place/The+Glencoe+Club,+Calgary,+AB/", description: "Iconic private club in the heart of the community" }
];
...
const faqs = [
  ...
  },
  {
    ...
    answer: "If you're not 100% satisfied, call us within 24 hours and we'll come back to your Elbow Park home and make it right — at no extra cost!"
  }
];
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-5 py-2 mb-6">
                ...
                <span className="text-white/90 text-sm font-medium">Serving Elbow Park, SW Calgary</span>
              </div>
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-2 mb-6">Cleaning Services Tailored to Elbow Park Living</h2>
                <div className="text-muted-foreground space-y-4 text-lg leading-relaxed">
                  <p>
                    Elbow Park blends historic character with quiet luxury — featuring grand heritage homes, mature elms, and easy access to the river pathways and Glencoe Club.
                  </p>
                  <p>
                    From stately estates to riverside bungalows, we tailor every visit to your space — bringing every supply we need — including any product you would rather we used.
                  </p>
                </div>
              </div>
            </AnimatedSection>
          ...
          <div className="container mx-auto px-4">
            ...
            <AnimatedSection>
              ...
              <p className="mt-10 text-center text-muted-foreground">
                {"Elbow Park is one of the Calgary neighbourhoods we clean — see "}
                <Link
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="text-center mb-14 max-w-3xl mx-auto">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-2 mb-4">Around Elbow Park</h2>
                <p className="text-muted-foreground text-lg">
                  We know the area inside and out — here are a few of the places that make Elbow Park feel like home.
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection>
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="text-center mb-10">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto">
                  We proudly serve families and homeowners across Elbow Park and surrounding SW Calgary communities.
                </p>
              </div>
      ...
      <LocationPricing />
        ...
        <section className="py-20 bg-brand-navy relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            <AnimatedSection>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Ready for a Spotless Home in Elbow Park?</h2>
