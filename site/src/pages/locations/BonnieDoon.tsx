...
const services = [
  { icon: Home, title: "Standard Cleaning", description: "A thorough one-time cleaning that resets the whole home, room by room.", to: "/edmonton/regular-cleaning/", linkText: "Standard cleaning in Bonnie Doon" },
  { icon: Sparkles, title: "Deep Cleaning", description: "A full top-to-bottom reset — corners, baseboards, and the surfaces regular visits skip.", to: "/edmonton/deep-cleaning/", linkText: "Deep cleaning in Bonnie Doon" },
  { icon: Truck, title: "Move In/Out Cleaning", description: "Detailed cleaning for a smooth Bonnie Doon move — leave or arrive to a pristine home.", to: "/move-out-cleaning-edmonton/", linkText: "Move-out cleaning in Bonnie Doon" },
              ...
              <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed text-lg">
                  ...
                  <p>
                    ...
                    <a href="https://www.google.com/maps/place/Bonnie+Doon+Shopping+Centre/" target="_blank" rel="noopener noreferrer" className="text-primary underline underline-offset-2">Bonnie Doon Centre</a>,
                    ...
                    minutes from <a href="https://www.google.com/maps/search/Bonnie+Doon+Park+Edmonton/" target="_blank" rel="noopener noreferrer" className="text-primary underline underline-offset-2">Bonnie Doon Park</a>,
                    or close to <a href="https://www.google.com/maps/place/Whyte+Ave,+Edmonton,+AB/" target="_blank" rel="noopener noreferrer" className="text-primary underline underline-offset-2">Whyte Avenue</a>,
          ...
          <div className="container mx-auto px-4">
            ...
            <AnimatedSection>
              ...
              <p className="mt-10 text-center text-muted-foreground">
                {"Bonnie Doon is one of the Edmonton neighbourhoods we clean — see "}
