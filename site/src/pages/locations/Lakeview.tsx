...
import featureImg from "@/assets/gallery/lakeview-clean-kitchen.jpg";
            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <div className="text-muted-foreground space-y-4 text-lg leading-relaxed">
                  ...
                  <p>Our cleaners bring the same level of care this neighbourhood is known for. From hardwood floors and large kitchens to wine rooms and walk-in showers, we tailor every clean to your home — using non-toxic products that are safe for kids, pets, and the lifestyle you've built here.</p>
                </div>
              </div>
            </AnimatedSection>
          </div>
