...
const services = [
  { icon: Home, title: "Standard Cleaning", description: "A thorough one-time cleaning to bring the whole home back to baseline.", to: "/calgary/regular-cleaning/", linkText: "Standard cleaning in Brentwood" },
  { icon: Sparkles, title: "Deep Cleaning", description: "Thorough top-to-bottom cleaning of your Brentwood home — every corner, baseboard, and hidden surface.", to: "/calgary/deep-cleaning/", linkText: "Deep cleaning in Brentwood" },
  { icon: Truck, title: "Move In/Out Cleaning", description: "Detailed cleaning for a smooth Brentwood move — leave or arrive to a pristine home.", to: "/move-out-cleaning-calgary/", linkText: "Move-out cleaning in Brentwood" },
            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <div className="text-muted-foreground space-y-4 text-lg leading-relaxed">
                  <p>
                    Brentwood is a mature, leafy NW Calgary community next to the University of Calgary, popular with students, professors, and long-time families. Busy weeks shouldn't mean a chaotic home. Regular visits keep things calm, fresh, and ready for whatever comes next.
                  </p>
                  <p>
