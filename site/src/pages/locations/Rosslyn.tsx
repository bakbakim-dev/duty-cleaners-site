    ...
    <LocationPageTemplate
      ...
      localNote={{
        ...
        paragraphs: [
          ...
          "The 97 Street and Yellowhead Trail corridors put road grit through the neighbourhood all winter, arriving dry because the cold here holds rather than thawing, and Rosslyn Park and the mature streets add pollen and leaf fall in their seasons. Flat rates by home size, no trip fee, quoted before you book.",
        ],
      }}
      phone="780-913-6565"
