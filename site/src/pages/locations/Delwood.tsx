...
import heroImg from "@/assets/gallery/delwood-cleaner-dining.jpg";
...
export default function Delwood() {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional house cleaning in Delwood, Edmonton. Trusted local cleaners serving north Edmonton families. Customer-rated cleaners and five-star rated service." />
  ...
  description: "Professional house cleaning services in Delwood, Edmonton.",
        ...
        <meta property="og:description" content="Professional house cleaning in Delwood, Edmonton. Trusted local cleaners serving north Edmonton families. Customer-rated cleaners and five-star rated service." />
        ...
        <meta name="twitter:description" content="Professional house cleaning in Delwood, Edmonton. Trusted local cleaners serving north Edmonton families. Customer-rated cleaners and five-star rated service." />
      </Helmet>
