...
import heroImg from "@/assets/gallery/belmont-cleaner-kitchen.jpg";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional house cleaning in Belmont, Edmonton. Trusted local cleaners serving northeast Edmonton families. Customer-rated cleaners and five-star rated service." />
