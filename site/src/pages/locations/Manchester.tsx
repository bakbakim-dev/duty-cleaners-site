...
const services = [
  { icon: Home, title: "Standard Cleaning", description: "A thorough one-time cleaning to refresh your Manchester home spotless and fresh year-round." },
  { icon: Sparkles, title: "Deep Cleaning", description: "Thorough top-to-bottom cleaning of your Manchester home — every corner, baseboard, and hidden surface." },
  { icon: Truck, title: "Move In/Out Cleaning", description: "Detailed cleaning for a smooth Manchester move — leave or arrive to a pristine home." },
  { icon: SprayCan, title: "Post-Construction Cleanup", description: "Expert dust and debris removal after renovations or new builds in Manchester." },
  { icon: Bath, title: "Bathroom Sanitization", description: "Deep scrubbing and disinfecting of showers, tubs, toilets, and tiles." },
  { icon: Building2, title: "Commercial Cleaning", description: "Professional office and commercial space cleaning for Manchester businesses of all sizes." },
];
...
const whyUsItems = [
  ...
  { icon: Clock, title: "Flexible Scheduling", description: "Same-day and next-day availability in Manchester. We work around your busy life." },
...
const landmarks = [
  {
    ...
    "url": "https://www.google.com/maps/place/Calgary+Farmers'+Market,+Calgary,+AB/",
    "description": "Weekend favourite for fresh local food"
  },
  {
    "title": "Chinook Centre",
    "url": "https://www.google.com/maps/place/CF+Chinook+Centre,+Calgary,+AB/",
    "description": "Calgary's largest shopping mall, just south"
  },
  {
    "title": "Macleod Trail",
    "url": "https://www.google.com/maps/place/Macleod+Trail,+Calgary,+AB/",
    "description": "Quick commute corridor to downtown"
  },
  {
    "title": "Stampede Park",
    "url": "https://www.google.com/maps/place/Stampede+Park,+Calgary,+AB/",
    "description": "Year-round events a short hop north"
  }
];
...
const faqs = [
  {
    ...
    answer: `We work to a checklist, not a clock. Your Manchester team stays until every task in your service scope is complete, and your flat rate does not change based on how long it takes.`
  },
  {
    question: "What cleaning services does Duty Cleaners offer in Manchester?",
    answer: `Around Manchester we offer the full range:\n\n• Commercial Cleaning\n• Standard & Deep Cleaning Packages\n• Move-In & Move-Out Cleaning\n• Post-Construction Cleaning\n• Wall Washing and Wall Cleaning`
  },
  {
    question: "Do you offer discounts?",
    answer: `Yes — recurring Manchester customers save:\n\n• Every week: 20% off\n• Every two weeks: 15% off\n• Every four weeks: 10% off`
  },
  {
    question: "What's included in a deep cleaning?",
    answer: `A Manchester deep clean adds to the standard package:\n\n• Wall outlet covers wiped\n• Cobweb removal\n• Ceiling fans dusted and cleaned\n• Light switches fully cleaned\n• All reachable vents cleaned\n• And more!`
  },
  {
    question: "What is your 100% satisfaction guarantee policy?",
    answer: "If you're not 100% satisfied, call us within 24 hours and we'll come back to your Manchester home and make it right — at no extra cost!"
  }
];
...
export default function Manchester() {
  useEffect(() => {
    document.title = "House Cleaning Services Manchester | Duty Cleaners";
    window.scrollTo(0, 0);
  }, []);
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="twitter:title" content="House Cleaning Services Manchester Calgary | Duty Cleaners" />
        <meta name="twitter:description" content="Professional house cleaning in Manchester, Calgary. Same-day service subject to availability. 100% satisfaction guaranteed." />
        <meta property="og:description" content="Professional house cleaning in Manchester, Calgary. Same-day service subject to availability. 100% satisfaction guaranteed." />
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-2 mb-6">Cleaning Services Tailored to Manchester Lofts & Homes</h2>
                <div className="text-muted-foreground space-y-4 text-lg leading-relaxed">
                  <p>Manchester is one of Calgary's most distinctive inner-city neighbourhoods, with brick warehouses being reborn as lofts, breweries, studios, and design-forward businesses just south of downtown.</p>
                  <p>Whether your space is a polished concrete loft or a refurbished warehouse condo, our team brings the right tools and professional products to keep every surface gleaming — and your air quality fresh.</p>
                </div>
              </div>
            </AnimatedSection>
          </div>
            ...
            <AnimatedSection>
              <div className="text-center mb-14">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
                  From routine upkeep to move-outs, Manchester homes get every service they need.
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection>
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="text-center mb-14 max-w-3xl mx-auto">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-2 mb-4">Around Manchester</h2>
                <p className="text-muted-foreground text-lg">
                  We know the area inside and out — here are a few of the places that make Manchester feel like home.
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection>
            ...
            <AnimatedSection>
              <div className="max-w-5xl mx-auto">
                ...
                <div className="rounded-2xl overflow-hidden shadow-xl border border-border">
                  <iframe
                    src="https://www.google.com/maps?q=Manchester,+Calgary,+AB&output=embed"
                    width="100%"
                    height="450"
                    style={{ border: 0 }}
                    allowFullScreen
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="text-center mb-10">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto">
                  We proudly serve families and homeowners across Manchester and surrounding SE Calgary communities.
                </p>
              </div>
      ...
      <LocationPricing />
            ...
            <AnimatedSection>
              <div className="text-center mb-14">
                ...
                <p className="text-white/90 max-w-2xl mx-auto text-lg">
                  Trusted by Manchester families for reliable, thorough cleaning.
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection>
        ...
        <section className="py-20 bg-brand-navy relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            <AnimatedSection>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Ready for a Spotless Home in Manchester?</h2>
