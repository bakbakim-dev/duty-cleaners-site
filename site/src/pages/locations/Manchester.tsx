            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <div className="text-muted-foreground space-y-4 text-lg leading-relaxed">
                  ...
                  <p>Whether your space is a polished concrete loft or a refurbished warehouse condo, our team brings the right tools and non-toxic products to keep every surface gleaming — and your air quality fresh.</p>
                </div>
              </div>
            </AnimatedSection>
          </div>
