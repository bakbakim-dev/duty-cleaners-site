...
import cleanHomeImg from "@/assets/gallery/neighborhoods/killarney.jpg";
...
export default function KillarneyGlengarry() {
  ...
  return (
    <>
      <Helmet>
        <title>House Cleaning Services in Killarney-Glengarry, Calgary | Duty Cleaners</title>
        <meta name="description" content="Professional house cleaning in Killarney-Glengarry, Calgary. Same-day service available. 100% satisfaction guaranteed. Pay after your clean. Get a free quote today!" />
        <meta property="og:title" content="House Cleaning Services Killarney-Glengarry Calgary | Duty Cleaners" />
        <meta property="og:description" content="Professional house cleaning in Killarney-Glengarry, Calgary. Same-day service available. 100% satisfaction guaranteed." />
