...
const services = [
  { icon: Home, title: "Standard Cleaning", description: "A thorough one-time cleaning that resets the whole home, room by room.", to: "/calgary/regular-cleaning/", linkText: "Standard cleaning in Killarney-Glengarry" },
  { icon: Sparkles, title: "Deep Cleaning", description: "A full top-to-bottom reset — corners, baseboards, and the surfaces regular visits skip.", to: "/calgary/deep-cleaning/", linkText: "Deep cleaning in Killarney-Glengarry" },
  { icon: Truck, title: "Move In/Out Cleaning", description: "Detailed cleaning for a smooth Killarney-Glengarry move — leave or arrive to a pristine home.", to: "/move-out-cleaning-calgary/", linkText: "Move-out cleaning in Killarney-Glengarry" },
...
const landmarks = [
  {
    "title": "Killarney Aquatic & Recreation Centre",
    "url": "https://www.google.com/maps/place/Killarney+Aquatic+%26+Recreation+Centre,+Calgary,+AB/",
    "description": "Pool, gym, and family programs steps away"
  },
  {
    "title": "17th Avenue SW",
    "url": "https://www.google.com/maps/place/17+Ave+SW,+Calgary,+AB/",
    "description": "Calgary's main shopping and dining strip"
  },
  {
    "title": "Westbrook LRT Station",
    "url": "https://www.google.com/maps/place/Westbrook+CTrain+Station,+Calgary,+AB/",
    "description": "Direct downtown access via the LRT"
  },
  {
    "title": "Richmond Green Park",
    "url": "https://www.google.com/maps/place/Richmond+Green+Park,+Calgary,+AB/",
    "description": "Sports fields and toboggan hill nearby"
  }
];
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-5 py-2 mb-6">
                ...
                <span className="text-white/90 text-sm font-medium">Serving Killarney-Glengarry, Calgary</span>
              </div>
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="text-center mb-14 max-w-3xl mx-auto">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-2 mb-4">Around Killarney-Glengarry</h2>
                <p className="text-muted-foreground text-lg">
                  We know the area inside and out — here are a few of the places that make Killarney-Glengarry feel like home.
                </p>
              </div>
            </AnimatedSection>
            <AnimatedSection>
            ...
            <AnimatedSection>
              <div className="max-w-5xl mx-auto">
                ...
                <div className="rounded-2xl overflow-hidden shadow-xl border border-border">
                  <iframe
                    src="https://www.google.com/maps?q=Killarney-Glengarry%2C%20Calgary%2C%20AB&output=embed"
                    width="100%"
                    height="450"
                    style={{ border: 0 }}
                    allowFullScreen
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="text-center mb-10">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto">
                  We proudly serve families and homeowners across Killarney-Glengarry and surrounding Calgary communities.
                </p>
              </div>
      ...
      <LocationPricing />
        ...
        <section className="py-20 bg-brand-navy relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            <AnimatedSection>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Ready for a Spotless Home in Killarney-Glengarry?</h2>
