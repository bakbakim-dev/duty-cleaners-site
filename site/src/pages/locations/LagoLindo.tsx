    ...
    <LocationPageTemplate
      ...
      localNote={{
        ...
        paragraphs: [
          ...
          "The homes here are established rather than new, so they tend to have more separate rooms and more trim, door frames and sills to hand-wipe than a modern build of the same footprint. That is worth mentioning when you book, because layout affects how long a clean takes more than bedroom count alone does. Flat rates by home size, no trip fee, quoted before you book.",
        ],
      }}
      phone="780-913-6565"
