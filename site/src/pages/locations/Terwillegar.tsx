...
const whyUsItems = [
  ...
  { icon: Leaf, title: "High Quality Cleaning Supplies", description: "Safe for your family, pets, and the planet — aligned with Terwillegar's nature-loving values." },
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Trusted, local house cleaning service for homes in Terwillegar, Edmonton. Professional cleaners serving Terwillegar Park, Magrath Heights, and surrounding areas." />
            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed text-lg">
                  <p>
                    Terwillegar is truly a gem in Southwest Edmonton, offering the best of both worlds — urban convenience and natural beauty. With direct access to <a href="https://www.google.com/maps/search/Terwillegar+Park+Edmonton" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-medium">Terwillegar Park</a> and the North Saskatchewan River Valley, this neighborhood attracts families, outdoor enthusiasts, and anyone who values a connection to nature.
                  </p>
                  <p>
