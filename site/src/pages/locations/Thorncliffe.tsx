...
import featureImg from "@/assets/gallery/thorncliffe-clean-home.jpg";
...
export default function Thorncliffe() {
  ...
  return (
    <>
      <Helmet>
        <title>House Cleaning Services in Thorncliffe, Calgary | Duty Cleaners</title>
            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto">
                ...
                <div className="text-muted-foreground space-y-4 text-lg leading-relaxed">
                  ...
                  <p>From classic bungalows to renovated infills and modern townhomes, every Thorncliffe space is different. We tailor each visit to fit your home — using non-toxic products that are safe for kids, pets, and everything you love.</p>
                </div>
              </div>
            </AnimatedSection>
          </div>
