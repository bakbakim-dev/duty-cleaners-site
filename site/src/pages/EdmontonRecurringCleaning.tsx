...
export default function EdmontonRecurringCleaning() {
  return (
    <ServiceDetailPage
      ...
      heroSubheading="The standard clean on a weekly, bi-weekly or every-4-weeks schedule. The first visit is charged at the one-time rate; from the second, 20% off weekly, 15% off bi-weekly and 10% off every 4 weeks."
      ...
      overviewParagraphs={[
        "Recurring cleaning is the standard checklist, kitchen, bathrooms, bedrooms and living areas, done on a weekly, bi-weekly or every-4-weeks schedule. You book once and the visits repeat; there is no contract, and you can change, skip or pause the schedule.",
      ...
      ctaHeading={<>Standard cleaning from {TIERS[0].price}, <AccentGold>discounted on a schedule.</AccentGold></>}
      ctaDescription={`The first visit is charged at the one-time rate, from ${TIERS[0].price} for a one-bedroom. From the second visit on, weekly is 20% off, bi-weekly 15% off and every 4 weeks 10% off. No contract; change or pause the schedule with ${POLICY.cancellationNoticeHours} hours' notice.`}
      galleryImages={[
