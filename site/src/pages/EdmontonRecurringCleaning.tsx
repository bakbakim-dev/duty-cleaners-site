...
export default function EdmontonRecurringCleaning() {
  return (
    <ServiceDetailPage
      ...
      overviewParagraphs={[
        "Recurring cleaning is an ongoing scheduled service designed to keep your Edmonton home consistently clean week after week. Choose the cadence that fits your household — weekly, bi-weekly, or every four weeks — and your home stays tidy, hygienic, and guest-ready without the hassle of booking each time.",
        ...
        "Your first clean is at the standard one-time rate; from your second visit on, recurring clients save on every visit: 20% off weekly, 15% off bi-weekly, and 10% off every-4-weeks cleanings. Our cleaners bring all supplies and equipment.",
      ]}
