...
export default function EdmontonDeepCleaning() {
  return (
    <ServiceDetailPage
      city="edmonton"
      crossCity={{ city: "Calgary", to: "/calgary/deep-cleaning/", description: "The same top-to-bottom deep clean, delivered by our Calgary team." }}
      quoteService="deep-cleaning"
      phone="(780) 913-6565"
      phoneHref="tel:7809136565"
      seoTitle="Deep Cleaning Services Edmonton | Duty Cleaners"
      seoDescription="Detailed deep cleaning in Edmonton: baseboards, switches, vents, exterior of appliances, and built-up grime removed. Professional products and a 100% satisfaction guarantee."
