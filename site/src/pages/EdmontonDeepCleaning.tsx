...
export default function EdmontonDeepCleaning() {
  return (
    <ServiceDetailPage
      ...
      included={[
        { icon: UtensilsCrossed, title: "Kitchen Detail Clean", description: "The team details the stovetop, grates and fridge top, wipes appliance exteriors, cabinet fronts and the backsplash, and sanitises all prep surfaces." },
