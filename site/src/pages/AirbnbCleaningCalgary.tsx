          ...
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 bg-calgary/10 rounded-full px-4 py-2 mb-4">
                <span className="dc-icon dc-icon-sparkles w-4 h-4 text-calgary" aria-hidden="true" />
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-muted/30 rounded-xl p-6 text-left">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="dc-icon dc-icon-map-pin w-4 h-4 text-calgary" aria-hidden="true" />
