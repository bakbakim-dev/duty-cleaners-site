...
const whyChooseUs = [
  ...
  { icon: Shield, title: "Pay After Your Clean", desc: "Customer-rated Calgary cleaners who work to a post-construction checklist from start to finish." },
...
const faqs = [
  ...
  },
  {
    ...
    a: "We work to a checklist, not a clock. Your team stays until every task in your service scope is complete, and your flat rate does not change based on how long it takes.",
  },
  {
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-muted-foreground mb-4">
                Even after the trades have packed up and the last tool has been put away, a freshly built or renovated Calgary home is anything but clean. Drywall dust settles on baseboards, vents, counters, window ledges, and floors. Fine particles work their way into cabinets and drawers. Smudges, fingerprints, and adhesive residue cling to windows, mirrors, and new fixtures.
              </p>
              <p className="text-lg text-muted-foreground mb-4">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <AnimatedSection>
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">Why Calgary Homeowners Choose Duty Cleaners</h2>
          ...
          <AnimatedSection>
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-base text-white/90 mb-8">
                Every Calgary post-construction job is reviewed against a detailed checklist before we leave — from cabinet interiors and window tracks to baseboards — so the home truly feels brand new.
              </p>
