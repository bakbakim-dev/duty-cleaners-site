...
const includedServices = [
  ...
  { icon: Droplets, title: "Floor Deep Cleaning", desc: "Sweeping, vacuuming, and mopping of hardwood, tile, vinyl, and laminate to lift fine dust and contractor footprints." },
  { icon: SprayCan, title: "Interior Window & Glass Cleaning", desc: "Smudges, fingerprints, paint flecks, and renovation residue removed from interior glass, mirrors, and glass doors." },
  { icon: Shield, title: "Surface Disinfection", desc: "Doors, handles, light switches, baseboards, window sills, and reachable high-touch areas wiped and sanitized." },
];
...
const excludedServices = [
  ...
  "No removal of plastics from new appliances, and no sticker removal from windows, doors, or surfaces",
...
const faqs = [
  ...
  },
  {
    ...
    a: "Most Calgary homes take between 4 and 10 hours depending on square footage, number of bathrooms, and how much fine dust remains. We work to a checklist, not a clock. Your team stays until every task in your service scope is complete, and your flat rate does not change based on how long it takes.",
  },
  {
...
export default function CalgaryPostConstruction() {
  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        <title>Post-Construction Cleaning Calgary | Duty Cleaners</title>
        <meta name="description" content="Final-stage post-construction cleaning in Calgary for newly built and renovated homes. Remove drywall dust, smudges, and contractor residue." />
        <link rel="canonical" href="https://dutycleaners.ca/post-construction-cleaning-calgary/" />
        <meta property="og:title" content="Post-Construction Cleaning Calgary | Duty Cleaners" />
        ...
        <script type="application/ld+json">
          {JSON.stringify(buildServiceSchema({ name: "Post-Construction Cleaning", description: "Final-stage post-construction cleaning in Calgary for newly built and renovated homes. Remove drywall dust, smudges, and contractor residue.", path: "/post-construction-cleaning-calgary", city: "calgary", offerFrom: Number(startingPriceLabel.replace(/[^0-9.]/g, "")), offerTo: Number(topPriceLabel.replace(/[^0-9.]/g, "")), offerNote: "Set by square footage and scope; quoted before booking." }))}
        </script>
      </Helmet>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-xl md:text-2xl text-white/80 max-w-3xl mb-4">
                Final-stage move-in cleaning for newly built and freshly renovated Calgary homes — completed projects only, ready for handover.
              </p>
        ...
        <AnimatedSection>
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-muted-foreground mb-4">
                At Duty Cleaners Calgary, we do <strong>final-stage post-construction cleaning</strong>: the move-in clean performed once construction is complete and the space is empty of debris. That covers new builds, kitchen and bathroom remodels, basement renovations and whole-home refreshes.
              </p>
      ...
      <section className="py-20 bg-brand-navy relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <AnimatedSection>
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-4 text-white">What's Included</h2>
            <p className="text-center text-white/90 mb-12 max-w-2xl mx-auto">
              Five parts of the clean: dust, kitchen and bathrooms, floors, interior glass, and the doors, handles and switches everyone touches.
            </p>
          </AnimatedSection>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <AnimatedSection>
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">Why Calgary Homeowners Choose Duty Cleaners</h2>
          </AnimatedSection>
          ...
          <AnimatedSection>
            <div className="max-w-3xl mx-auto text-center">
              <div className="inline-flex items-center gap-2 bg-accent/20 rounded-full px-4 py-2 mb-6">
                ...
                <span className="text-accent text-sm font-semibold">TRUSTED ACROSS CALGARY SINCE 2017</span>
              </div>
              ...
              <p className="text-base text-white/90 mb-8">
                Every Calgary post-construction job is checked against the checklist before we leave: cabinet interiors, window tracks, baseboards.
              </p>
        ...
        <div className="container mx-auto px-4">
          <AnimatedSection>
            ...
            <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
              Answers to the questions Calgary homeowners, builders, and renovators ask us most.
            </p>
          </AnimatedSection>
          <AnimatedSection>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {[
              { icon: Phone, title: "Give us a call", desc: "Questions before you book", action: "(403) 768-1341", href: "tel:4037681341" },
