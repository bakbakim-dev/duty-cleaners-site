...
export const GUARD_PROOFS: GuardProof[] = [
  ...
  },
  {
    ...
    find: "Red Deer is served too:",
    replace: "Duty Cleaners does not serve Red Deer:",
    failing: "nothing says Red Deer is not served",
    why: "Restores the 'does not serve Red Deer' line the owner contradicted on 2026-09-11.",
  },
  {
    guard: "src/data/owner-answers-0911.test.ts",
    target: "src/pages/EdmontonPricing.tsx",
  ...
  },
  {
    guard: "src/data/quote-funnel-0911.test.ts",
    target: "src/components/quote/QuoteFlow.tsx",
    find: "!redDeer && (cityStatus === \"unknown\"",
    replace: "(cityStatus === \"unknown\"",
    failing: "QuoteFlow adds no travel fee and no online booking for a Red Deer code",
    why: "Charges a Red Deer address the Edmonton/Calgary travel fee, whose Red Deer amount is not on file.",
  },
  {
    guard: "src/lib/booking-redirect.test.ts",
    target: "src/lib/booking-redirect.ts",
