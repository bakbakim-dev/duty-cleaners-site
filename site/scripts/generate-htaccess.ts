...
out.push(
  ...
  "  RewriteEngine On",
  "",
  "  # Canonical host and scheme. SiteGround terminates TLS before this runs, so",
  "  # HTTPS is checked via the forwarded header as well as the direct one.",
...
out.push(
  ...
  "  # policy that misses one takes the page down. HSTS is deliberately NOT set —",
  "  # it is a one-way door and the owner's call to make knowingly.",
