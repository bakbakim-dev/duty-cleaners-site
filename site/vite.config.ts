...
const IMAGE_PRESETS: Record<string, string> = {
  ...
  // 640 closes the large jump from 480 to 768: a ~314 CSS-px card on a 2x
  // phone needs about 628 device pixels and previously downloaded the 768w
  // file. Lighthouse measured 174 KiB of avoidable image transfer across the
  // six cards on the Edmonton Airbnb page from that gap.
  card: "w=480;640;768;1024&format=webp&quality=78&as=picture",
